...
pub struct CheckInResponse {
    ...
    pub features: ::std::option::Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
...
pub struct WorkerStatus {
    ...
    pub attached_disks:
        ::std::option::Option<::std::collections::BTreeMap<String, ::std::boxed::Box<DiskStatus>>>,
