...
pub mod schemas {
    ...
    pub struct Action {
        ...
        pub flags: ::std::option::Option<::std::vec::Vec<ActionFlagsEnum>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    pub enum ActionFlagsEnum {
        #[serde(rename = "FLAG_UNSPECIFIED")]
        #[doc = "Unspecified flag."]
        FlagUnspecified,
        #[serde(rename = "IGNORE_EXIT_STATUS")]
        ...
        EnableFuse,
        #[serde(rename = "PUBLISH_EXPOSED_PORTS")]
        ...
        PublishExposedPorts,
        #[serde(rename = "DISABLE_IMAGE_PREFETCH")]
        ...
        #[serde(rename = "DISABLE_STANDARD_ERROR_CAPTURE")]
        ...
        #[serde(rename = "BLOCK_EXTERNAL_NETWORK")]
        #[doc = "Prevents the container from accessing the external network."]
        BlockExternalNetwork,
    }
    impl ::std::default::Default for ActionFlagsEnum {
        fn default() -> Self {
            Self::FlagUnspecified
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "The parameters to the CheckIn method."]
    pub struct CheckInRequest {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "deadlineExpired")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The deadline has expired and the worker needs more time."]
        pub deadline_expired: ::std::option::Option<::std::boxed::Box<Empty>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "event")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        pub events: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<TimestampedEvent>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "result")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The operation has finished with the given result."]
        pub result: ::std::option::Option<::std::boxed::Box<Status>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "sosReport")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "An SOS report for an unexpected VM failure."]
        pub sos_report: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "workerStatus")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Data about the status of the worker VM."]
        pub worker_status: ::std::option::Option<::std::boxed::Box<WorkerStatus>>,
    }
    impl CheckInRequest {
        pub fn builder() -> CheckInRequestBuilder {
            CheckInRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "The response to the CheckIn method."]
    ...
    impl CheckInResponse {
        pub fn builder() -> CheckInResponseBuilder {
            CheckInResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "The status of a disk on a VM."]
    pub struct DiskStatus {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "freeSpaceBytes")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Free disk space."]
        pub free_space_bytes: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "totalSpaceBytes")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Total disk space."]
        pub total_space_bytes: ::std::option::Option<::std::string::String>,
    }
    impl DiskStatus {
        pub fn builder() -> DiskStatusBuilder {
            DiskStatusBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "The arguments to the `RunPipeline` method. The requesting user must have the `iam.serviceAccounts.actAs` permission for the Cloud Genomics service account or the request will fail."]
    ...
    #[doc = "An event that occured in the operation assigned to the worker and the time of occurance."]
    ...
    impl TimestampedEvent {
        pub fn builder() -> TimestampedEventBuilder {
            TimestampedEventBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "The status of the worker VM."]
    pub struct WorkerStatus {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "attachedDisks")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Status of attached disks."]
        pub attached_disks: ::std::option::Option<
            ::std::collections::BTreeMap<String, ::std::boxed::Box<DiskStatus>>,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "bootDisk")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Status of the boot disk."]
        pub boot_disk: ::std::option::Option<::std::boxed::Box<DiskStatus>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "freeRamBytes")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Free RAM."]
        pub free_ram_bytes: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "totalRamBytes")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Total RAM."]
        pub total_ram_bytes: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl WorkerStatus {
        pub fn builder() -> WorkerStatusBuilder {
            WorkerStatusBuilder::default()
        }
    }
}
