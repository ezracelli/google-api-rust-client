...
pub mod schemas {
    ...
    impl AddPublicKeyMetadata {
        pub fn builder() -> AddPublicKeyMetadataBuilder {
            AddPublicKeyMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl AddPublicKeyRequest {
        pub fn builder() -> AddPublicKeyRequestBuilder {
            AddPublicKeyRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl AddPublicKeyResponse {
        pub fn builder() -> AddPublicKeyResponseBuilder {
            AddPublicKeyResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl AuthorizeEnvironmentMetadata {
        pub fn builder() -> AuthorizeEnvironmentMetadataBuilder {
            AuthorizeEnvironmentMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl AuthorizeEnvironmentResponse {
        pub fn builder() -> AuthorizeEnvironmentResponseBuilder {
            AuthorizeEnvironmentResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl CreateEnvironmentMetadata {
        pub fn builder() -> CreateEnvironmentMetadataBuilder {
            CreateEnvironmentMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl DeleteEnvironmentMetadata {
        pub fn builder() -> DeleteEnvironmentMetadataBuilder {
            DeleteEnvironmentMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl RemovePublicKeyMetadata {
        pub fn builder() -> RemovePublicKeyMetadataBuilder {
            RemovePublicKeyMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl RemovePublicKeyRequest {
        pub fn builder() -> RemovePublicKeyRequestBuilder {
            RemovePublicKeyRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl RemovePublicKeyResponse {
        pub fn builder() -> RemovePublicKeyResponseBuilder {
            RemovePublicKeyResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
