...
pub struct GoogleCloudVideointelligenceV1VideoContext {
    ...
    pub face_detection_config:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVideointelligenceV1FaceDetectionConfig>>,
    ...
    pub text_detection_config:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVideointelligenceV1TextDetectionConfig>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Video segment."]
