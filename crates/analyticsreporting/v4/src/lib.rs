...
pub struct SearchUserActivityResponse {
    ...
    pub sessions: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<UserActivitySession>>>,
...
pub struct SegmentDefinition {
    ...
    pub segment_filters: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<SegmentFilter>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Dimension filter specifies the filtering options on a dimension."]
