...
pub struct GoogleCloudDocumentaiV1beta2ProcessDocumentRequest {
    ...
    pub form_extraction_params:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2FormExtractionParams>>,
    #[serde(rename = "inputConfig")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub ocr_params: ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2OcrParams>>,
    #[serde(rename = "outputConfig")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub table_extraction_params:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2TableExtractionParams>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Response to a single document processing request."]
