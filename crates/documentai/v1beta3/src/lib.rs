...
pub struct GoogleCloudDocumentaiUiv1beta3TrainProcessorVersionMetadataDatasetValidation {
    ...
    pub dataset_errors: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleRpcStatus>>>,
    ...
    pub document_errors: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleRpcStatus>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1ReviewDocumentOperationMetadata {
    ...
    #[doc = "The basic metadata of the long running operation."]
    pub common_metadata:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1CommonOperationMetadata>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentEntity {
    ...
    pub page_anchor:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentPageAnchor>>,
    ...
    pub provenance:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentProvenance>>,
    ...
    pub text_anchor:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentTextAnchor>>,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentPage {
    ...
    pub dimension:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentPageDimension>>,
    ...
    pub layout:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentPageLayout>>,
    #[serde(rename = "lines")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub visual_elements: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentPageVisualElement>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentPageAnchor {
    ...
    pub page_refs: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRef>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRef {
    ...
    pub layout_type:
        ::std::option::Option<GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRefLayoutTypeEnum>,
    #[serde(rename = "page")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentPageTable {
    ...
    pub body_rows: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentPageTableTableRow>>,
    >,
    #[serde(rename = "detectedLanguages")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of detected languages together with confidence."]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentPageTableTableRow {
    ...
    pub cells: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentPageTableTableCell>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreak {
    ...
    pub _type:
        ::std::option::Option<GoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreakTypeEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Detected break type."]
...
pub struct GoogleCloudDocumentaiV1beta1DocumentProvenance {
    ...
    pub parents: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentProvenanceParent>>,
    >,
...
pub struct GoogleCloudDocumentaiV1beta1DocumentStyle {
    ...
    #[doc = "Font size."]
    pub font_size:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta1DocumentStyleFontSize>>,
...
pub struct GoogleCloudDocumentaiV1beta1InputConfig {
    ...
    pub gcs_source: ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta1GcsSource>>,
    #[serde(rename = "mimeType")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudDocumentaiV1beta2DocumentEntity {
    ...
    #[doc = "Optional. Represents the provenance of this entity wrt. the location on the page where it was found."]
    pub page_anchor:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentPageAnchor>>,
    #[serde(rename = "properties")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Optional. Entities can be nested to form a hierarchical data structure representing the content in the document."]
    pub properties: ::std::option::Option<
    ...
    #[doc = "Optional. The history of this annotation."]
    pub provenance:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentProvenance>>,
    #[serde(rename = "redacted")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Optional. Whether the entity will be redacted for de-identification purposes."]
    pub redacted: ::std::option::Option<::std::primitive::bool>,
    ...
    #[doc = "Provenance of the entity. Text anchor indexing into the Document.text."]
    pub text_anchor:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentTextAnchor>>,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Entity type from a schema e.g. `Address`."]
    pub _type: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta2DocumentPage {
    ...
    #[doc = "Physical dimension of the page."]
    pub dimension:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentPageDimension>>,
    #[serde(rename = "formFields")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of visually detected form fields on the page."]
    pub form_fields: ::std::option::Option<
    ...
    #[doc = "Layout for the page."]
    pub layout:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentPageLayout>>,
    #[serde(rename = "lines")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of visually detected text lines on the page. A collection of tokens that a human would perceive as a line."]
    pub lines: ::std::option::Option<
    ...
    #[doc = "A list of detected non-text visual elements e.g. checkbox, signature etc. on the page."]
    pub visual_elements: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentPageVisualElement>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta2DocumentPageAnchor {
    ...
    #[doc = "One or more references to visual page elements"]
    pub page_refs: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef {
    ...
    #[doc = "Optional. The type of the layout element that is being referenced if any."]
    pub layout_type:
        ::std::option::Option<GoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRefLayoutTypeEnum>,
    #[serde(rename = "page")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Required. Index into the Document.pages element, for example using Document.pages to locate the related page element."]
    pub page: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta2DocumentPageTable {
    ...
    #[doc = "Body rows of the table."]
    pub body_rows: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentPageTableTableRow>>,
    >,
    #[serde(rename = "detectedLanguages")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of detected languages together with confidence."]
...
pub struct GoogleCloudDocumentaiV1beta2DocumentPageTableTableRow {
    ...
    #[doc = "Cells that make up this row."]
    pub cells: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak {
    ...
    #[doc = "Detected break type."]
    pub _type:
        ::std::option::Option<GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreakTypeEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Detected break type."]
...
pub struct GoogleCloudDocumentaiV1beta2DocumentProvenance {
    ...
    #[doc = "References to the original elements that are replaced."]
    pub parents: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentProvenanceParent>>,
    >,
    #[serde(rename = "revision")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The index of the revision that produced this element."]
...
pub struct GoogleCloudDocumentaiV1beta2DocumentStyle {
    ...
    #[doc = "Font size."]
    pub font_size:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2DocumentStyleFontSize>>,
    #[serde(rename = "fontWeight")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Font weight. Possible values are normal, bold, bolder, and lighter. https://www.w3schools.com/cssref/pr_font_weight.asp"]
    pub font_weight: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta2InputConfig {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The Google Cloud Storage location to read the input from. This must be a single file."]
    pub gcs_source: ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta2GcsSource>>,
    #[serde(rename = "mimeType")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Required. Mimetype of the input. Current supported mimetypes are application/pdf, image/tiff, and image/gif. In addition, application/json type is supported for requests with ProcessDocumentRequest.automl_params field set. The JSON file needs to be in Document format."]
    pub mime_type: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta3BatchProcessRequest {
    ...
    pub document_output_config:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentOutputConfig>>,
...
pub struct GoogleCloudDocumentaiV1beta3CommonOperationMetadata {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The state of the operation."]
    pub state: ::std::option::Option<GoogleCloudDocumentaiV1beta3CommonOperationMetadataStateEnum>,
    #[serde(rename = "stateMessage")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A message providing more details about the current state of processing."]
    pub state_message: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta3DocumentEntity {
    ...
    #[doc = "Optional. Represents the provenance of this entity wrt. the location on the page where it was found."]
    pub page_anchor:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentPageAnchor>>,
    #[serde(rename = "properties")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Optional. Entities can be nested to form a hierarchical data structure representing the content in the document."]
    pub properties: ::std::option::Option<
    ...
    #[doc = "Optional. The history of this annotation."]
    pub provenance:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentProvenance>>,
    #[serde(rename = "redacted")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Optional. Whether the entity will be redacted for de-identification purposes."]
    pub redacted: ::std::option::Option<::std::primitive::bool>,
    ...
    #[doc = "Provenance of the entity. Text anchor indexing into the Document.text."]
    pub text_anchor:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentTextAnchor>>,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Entity type from a schema e.g. `Address`."]
    pub _type: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta3DocumentPage {
    ...
    #[doc = "Physical dimension of the page."]
    pub dimension:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentPageDimension>>,
    #[serde(rename = "formFields")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of visually detected form fields on the page."]
    pub form_fields: ::std::option::Option<
    ...
    #[doc = "Layout for the page."]
    pub layout:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentPageLayout>>,
    #[serde(rename = "lines")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of visually detected text lines on the page. A collection of tokens that a human would perceive as a line."]
    pub lines: ::std::option::Option<
    ...
    #[doc = "A list of detected non-text visual elements e.g. checkbox, signature etc. on the page."]
    pub visual_elements: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentPageVisualElement>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta3DocumentPageAnchor {
    ...
    #[doc = "One or more references to visual page elements"]
    pub page_refs: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef {
    ...
    #[doc = "Optional. The type of the layout element that is being referenced if any."]
    pub layout_type:
        ::std::option::Option<GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRefLayoutTypeEnum>,
    #[serde(rename = "page")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Required. Index into the Document.pages element, for example using Document.pages to locate the related page element."]
    pub page: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta3DocumentPageTable {
    ...
    #[doc = "Body rows of the table."]
    pub body_rows: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow>>,
    >,
    #[serde(rename = "detectedLanguages")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of detected languages together with confidence."]
...
pub struct GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow {
    ...
    #[doc = "Cells that make up this row."]
    pub cells: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentPageTableTableCell>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak {
    ...
    #[doc = "Detected break type."]
    pub _type:
        ::std::option::Option<GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreakTypeEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Detected break type."]
...
pub struct GoogleCloudDocumentaiV1beta3DocumentProvenance {
    ...
    #[doc = "References to the original elements that are replaced."]
    pub parents: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentProvenanceParent>>,
    >,
    #[serde(rename = "revision")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The index of the revision that produced this element."]
...
pub struct GoogleCloudDocumentaiV1beta3DocumentStyle {
    ...
    #[doc = "Font size."]
    pub font_size:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentStyleFontSize>>,
    #[serde(rename = "fontWeight")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Font weight. Possible values are normal, bold, bolder, and lighter. https://www.w3schools.com/cssref/pr_font_weight.asp"]
    pub font_weight: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDocumentaiV1beta3ProcessRequest {
    ...
    pub document: ::std::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3Document>>,
...
pub struct GoogleCloudDocumentaiV1beta3ReviewDocumentOperationMetadata {
    ...
    pub state:
        ::std::option::Option<GoogleCloudDocumentaiV1beta3ReviewDocumentOperationMetadataStateEnum>,
    #[serde(rename = "stateMessage")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A message providing more details about the current state of processing. For example, the error message if the operation is failed."]
    pub state_message: ::std::option::Option<::std::string::String>,
