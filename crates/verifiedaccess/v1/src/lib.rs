...
pub mod schemas {
    ...
    impl VerifyChallengeResponseRequest {
        pub fn builder() -> VerifyChallengeResponseRequestBuilder {
            VerifyChallengeResponseRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl VerifyChallengeResponseResult {
        pub fn builder() -> VerifyChallengeResponseResultBuilder {
            VerifyChallengeResponseResultBuilder::default()
        }
    }
}
