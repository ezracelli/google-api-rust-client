        ...
        pub mod methods {
            ...
            pub mod list {
                ...
                pub enum QueryParametersViewEnum {
                    ...
                    #[doc = "This view contains all devices imported by the company admin. Each device in the response contains all information specified by the company admin when importing the device (i.e. asset tags). This includes devices that may be unaassigned or assigned to users."]
                    CompanyInventory,
                        ...
                        pub mod methods {
                            ...
                            pub mod list {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Optional. Additional restrictions when fetching list of client states."]
                                    pub filter: ::std::option::Option<::std::string::String>,
                                    #[builder(
                                        default = "{ ::std::default::Default::default() }",
                                        setter(into)
                                    ...
                                    #[doc = "Optional. Order specification for client states in the response."]
                                    pub order_by: ::std::option::Option<::std::string::String>,
                                    #[builder(
                                        default = "{ ::std::default::Default::default() }",
                                        setter(into)
                                    ...
                                    #[doc = "Optional. A page token, received from a previous `ListClientStates` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListClientStates` must match the call that provided the page token."]
                                    pub page_token: ::std::option::Option<::std::string::String>,
                                }
                                impl QueryParameters {
                                    pub fn builder() -> QueryParametersBuilder {
        ...
        pub mod methods {
            pub mod create {
                ...
                pub struct QueryParameters {
                    ...
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "Optional. The initial configuration option for the `Group`."]
            ...
            pub mod lookup {
                ...
                pub struct QueryParameters {
                    ...
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "The ID of the entity. For Google-managed entities, the `id` should be the email address of an existing group or user. For external-identity-mapped entities, the `id` must be a string conforming to the Identity Source's requirements. Must be unique within a `namespace`."]
...
pub mod schemas {
    ...
    pub struct DynamicGroupQuery {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Resource type for the Dynamic Group Query"]
    ...
    impl GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequestBuilder {
            GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequestBuilder {
            GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequest {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequestBuilder {
            GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequestBuilder {
            GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message that is returned in ListClientStates."]
    pub struct GoogleAppsCloudidentityDevicesV1ListClientStatesResponse {
        ...
        pub client_states: ::std::option::Option<
    ...
    impl GoogleAppsCloudidentityDevicesV1ListClientStatesResponse {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1ListClientStatesResponseBuilder {
            GoogleAppsCloudidentityDevicesV1ListClientStatesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse {
        ...
        pub device_users: ::std::option::Option<
    ...
    impl GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponseBuilder {
            GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleAppsCloudidentityDevicesV1ListDevicesResponse {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1ListDevicesResponseBuilder {
            GoogleAppsCloudidentityDevicesV1ListDevicesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponseBuilder {
            GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleAppsCloudidentityDevicesV1WipeDeviceRequest {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1WipeDeviceRequestBuilder {
            GoogleAppsCloudidentityDevicesV1WipeDeviceRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest {
        pub fn builder() -> GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequestBuilder {
            GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message for ListGroups operation."]
    pub struct ListGroupsResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "groups")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Groups returned in response to list request. The results are not sorted."]
        pub groups: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Group>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "nextPageToken")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub struct LookupGroupNameResponse {
        ...
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The [resource name](https://cloud.google.com/apis/design/resource_names) of the looked-up `Group`."]
        pub name: ::std::option::Option<::std::string::String>,
    }
    ...
    pub struct UpdateMembershipRolesParams {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The `MembershipRole`s to be updated. Only `MEMBER` `MembershipRole` can currently be updated."]
