...
pub struct ResponsePolicy {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "List of network names specifying networks to which this policy is applied."]
    pub networks: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ResponsePolicyNetwork>>>,
...
pub struct ResponsePolicyRuleLocalData {
    ...
    pub local_datas: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ResourceRecordSet>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
