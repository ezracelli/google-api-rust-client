...
pub mod schemas {
    ...
    impl GoogleCloudPolicytroubleshooterV1AccessTuple {
        pub fn builder() -> GoogleCloudPolicytroubleshooterV1AccessTupleBuilder {
            GoogleCloudPolicytroubleshooterV1AccessTupleBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleCloudPolicytroubleshooterV1BindingExplanation {
        ...
        pub access:
            ::std::option::Option<GoogleCloudPolicytroubleshooterV1BindingExplanationAccessEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub relevance:
            ::std::option::Option<GoogleCloudPolicytroubleshooterV1BindingExplanationRelevanceEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "role")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl GoogleCloudPolicytroubleshooterV1BindingExplanation {
        pub fn builder() -> GoogleCloudPolicytroubleshooterV1BindingExplanationBuilder {
            GoogleCloudPolicytroubleshooterV1BindingExplanationBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Required. Indicates whether _this binding_ provides the specified permission to the specified member for the specified resource. This field does _not_ indicate whether the member actually has the permission for the resource. There might be another binding that overrides this binding. To determine whether the member actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse."]
    ...
    impl ::std::default::Default for GoogleCloudPolicytroubleshooterV1BindingExplanationAccessEnum {
        fn default() -> Self {
    ...
    impl ::std::default::Default for GoogleCloudPolicytroubleshooterV1BindingExplanationRelevanceEnum {
        fn default() -> Self {
    ...
    impl ::std::default::Default
        for GoogleCloudPolicytroubleshooterV1BindingExplanationRolePermissionEnum
    {
        fn default() -> Self {
    ...
    impl ::std::default::Default
        for GoogleCloudPolicytroubleshooterV1BindingExplanationRolePermissionRelevanceEnum
    {
        fn default() -> Self {
            Self::HeuristicRelevanceUnspecified
        }
    ...
    impl GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership {
        pub fn builder(
        ) -> GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipBuilder {
            GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Indicates whether the binding includes the member."]
    ...
    impl ::std::default::Default
        for GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipMembershipEnum
    {
        fn default() -> Self {
    ...
    impl ::std::default::Default
        for GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevanceEnum
    {
        fn default() -> Self {
            Self::HeuristicRelevanceUnspecified
        }
    ...
    pub struct GoogleCloudPolicytroubleshooterV1ExplainedPolicy {
        ...
        pub access:
            ::std::option::Option<GoogleCloudPolicytroubleshooterV1ExplainedPolicyAccessEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub binding_explanations: ::std::option::Option<
            ::std::vec::Vec<::std::boxed::Box<GoogleCloudPolicytroubleshooterV1BindingExplanation>>,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "fullResourceName")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        pub relevance:
            ::std::option::Option<GoogleCloudPolicytroubleshooterV1ExplainedPolicyRelevanceEnum>,
    }
    impl GoogleCloudPolicytroubleshooterV1ExplainedPolicy {
        pub fn builder() -> GoogleCloudPolicytroubleshooterV1ExplainedPolicyBuilder {
            GoogleCloudPolicytroubleshooterV1ExplainedPolicyBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Indicates whether _this policy_ provides the specified permission to the specified member for the specified resource. This field does _not_ indicate whether the member actually has the permission for the resource. There might be another policy that overrides this policy. To determine whether the member actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse."]
    ...
    impl ::std::default::Default for GoogleCloudPolicytroubleshooterV1ExplainedPolicyAccessEnum {
        fn default() -> Self {
            Self::AccessStateUnspecified
        }
    }
    ...
    impl ::std::default::Default for GoogleCloudPolicytroubleshooterV1ExplainedPolicyRelevanceEnum {
        fn default() -> Self {
            Self::HeuristicRelevanceUnspecified
        }
    }
    ...
    pub struct GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest {
        ...
        pub access_tuple:
            ::std::option::Option<::std::boxed::Box<GoogleCloudPolicytroubleshooterV1AccessTuple>>,
    }
    impl GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest {
        pub fn builder() -> GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequestBuilder {
            GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse {
        ...
        pub explained_policies: ::std::option::Option<
            ::std::vec::Vec<::std::boxed::Box<GoogleCloudPolicytroubleshooterV1ExplainedPolicy>>,
        >,
    }
    impl GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse {
        pub fn builder() -> GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponseBuilder {
            GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponseBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Indicates whether the member has the specified permission for the specified resource, based on evaluating all of the applicable IAM policies."]
    ...
    impl ::std::default::Default
        for GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponseAccessEnum
    {
        fn default() -> Self {
            Self::AccessStateUnspecified
        }
