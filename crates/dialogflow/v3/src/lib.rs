...
pub struct GoogleCloudDialogflowCxV3DetectIntentRequest {
    ...
    pub query_input: ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3QueryInput>>,
...
pub struct GoogleCloudDialogflowCxV3Experiment {
    ...
    pub result: ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3ExperimentResult>>,
...
pub struct GoogleCloudDialogflowCxV3ListAgentsResponse {
    ...
    pub agents:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3Agent>>>,
...
pub struct GoogleCloudDialogflowCxV3ListFlowsResponse {
    ...
    pub flows:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3Flow>>>,
    #[serde(rename = "nextPageToken")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Token to retrieve the next page of results, or empty if there are no more results in the list."]
    pub next_page_token: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDialogflowCxV3ListIntentsResponse {
    ...
    pub intents:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3Intent>>>,
    #[serde(rename = "nextPageToken")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Token to retrieve the next page of results, or empty if there are no more results in the list."]
    pub next_page_token: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDialogflowCxV3ListPagesResponse {
    ...
    pub pages:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3Page>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDialogflowCxV3ListVersionsResponse {
    ...
    pub versions:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3Version>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDialogflowCxV3ListWebhooksResponse {
    ...
    pub webhooks:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3Webhook>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudDialogflowCxV3MatchIntentResponse {
    ...
    pub matches:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3Match>>>,
    #[serde(rename = "text")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudDialogflowCxV3OutputAudioConfig {
    ...
    pub synthesize_speech_config:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3SynthesizeSpeechConfig>>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Required. Audio encoding of the synthesized audio content."]
...
pub struct GoogleCloudDialogflowCxV3QueryResult {
    ...
    pub sentiment_analysis_result:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3SentimentAnalysisResult>>,
    #[serde(rename = "text")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "If natural language text was provided as input, this field will contain a copy of the text."]
    pub text: ::std::option::Option<::std::string::String>,
...
pub struct GoogleCloudDialogflowCxV3Webhook {
    ...
    pub generic_web_service:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3WebhookGenericWebService>>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
