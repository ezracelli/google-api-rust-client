...
pub struct GoogleCloudDialogflowCxV3beta1CalculateCoverageResponse {
    ...
    pub transition_coverage:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3beta1TransitionCoverage>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "One interaction between a human and virtual agent. The human provides some input and the virtual agent provides a response."]
...
pub struct GoogleCloudDialogflowCxV3beta1DetectIntentRequest {
    ...
    pub output_audio_config:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3beta1OutputAudioConfig>>,
...
pub struct GoogleCloudDialogflowCxV3beta1EntityType {
    ...
    pub excluded_phrases: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase>>,
    >,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudDialogflowCxV3beta1Experiment {
    ...
    pub result:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3beta1ExperimentResult>>,
...
pub struct GoogleCloudDialogflowCxV3beta1ExperimentResultMetric {
    ...
    pub count_type:
        ::std::option::Option<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricCountTypeEnum>,
    #[serde(rename = "ratio")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub _type: ::std::option::Option<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricTypeEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Count-based metric type. Only one of type or count_type is specified in each Metric."]
...
pub struct GoogleCloudDialogflowCxV3beta1ExperimentResultVersionMetrics {
    ...
    pub metrics: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3beta1ExperimentResultMetric>>,
    >,
...
pub struct GoogleCloudDialogflowCxV3beta1ExportTestCasesRequest {
    ...
    pub data_format:
        ::std::option::Option<GoogleCloudDialogflowCxV3beta1ExportTestCasesRequestDataFormatEnum>,
    #[serde(rename = "filter")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudDialogflowCxV3beta1FulfillIntentRequest {
    ...
    pub match_intent_request:
        ::std::option::Option<::std::boxed::Box<GoogleCloudDialogflowCxV3beta1MatchIntentRequest>>,
    #[serde(rename = "outputAudioConfig")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudDialogflowCxV3beta1NluSettings {
    ...
    pub model_type: ::std::option::Option<GoogleCloudDialogflowCxV3beta1NluSettingsModelTypeEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Indicates NLU model training mode."]
...
pub struct GoogleCloudDialogflowCxV3beta1SecuritySettings {
    ...
    pub redaction_strategy:
        ::std::option::Option<GoogleCloudDialogflowCxV3beta1SecuritySettingsRedactionStrategyEnum>,
...
pub struct GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverage {
    ...
    pub coverages: ::std::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage>,
        >,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
...
pub struct GoogleCloudDialogflowCxV3beta1VersionVariants {
    ...
    pub variants: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDialogflowCxV3beta1VersionVariantsVariant>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
