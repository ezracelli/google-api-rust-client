...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Campaign Manager IDs related to the custom event."]
pub struct CampaignManagerIds {
    #[serde(rename = "adId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Ad ID for Campaign Manager."]
    pub ad_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "campaignId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Campaign ID for Campaign Manager."]
    pub campaign_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "creativeId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Creative ID for Campaign Manager."]
    pub creative_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#campaignManagerIds\"."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "placementId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Placement ID for Campaign Manager."]
    pub placement_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "siteId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Site ID for Campaign Manager."]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Represents a DfaReporting channel grouping."]
pub struct ChannelGrouping {
    #[serde(rename = "fallbackName")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "ChannelGrouping fallback name."]
    pub fallback_name: ::std::option::Option<::std::string::String>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The kind of resource this is, in this case dfareporting#channelGrouping."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "ChannelGrouping name."]
    pub name: ::std::option::Option<::std::string::String>,
    #[serde(rename = "rules")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The rules contained within this channel grouping."]
    pub rules: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ChannelGroupingRule>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Represents a DfaReporting channel grouping rule."]
pub struct ChannelGroupingRule {
    #[serde(rename = "disjunctiveMatchStatements")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The disjunctive match statements contained within this rule."]
    pub disjunctive_match_statements:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<DisjunctiveMatchStatement>>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The kind of resource this is, in this case dfareporting#channelGroupingRule."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Rule name."]
...
pub struct CompatibleFields {
    ...
    pub path_attribution_report_compatible_fields:
        ::std::option::Option<::std::boxed::Box<PathReportCompatibleFields>>,
...
pub struct Conversion {
    ...
    pub dclid: ::std::option::Option<::std::string::String>,
...
pub struct Creative {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Online behavioral advertising icon to be added to the creative. Applicable to the following creative types: all INSTREAM_VIDEO."]
...
pub struct CreativeAssetMetadata {
    ...
    #[serde(rename = "counterCustomEvents")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "List of counter events configured for the asset. This is a read-only, auto-generated field and only applicable to a rich media asset."]
    pub counter_custom_events:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CreativeCustomEvent>>>,
    #[serde(rename = "detectedFeatures")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[serde(rename = "exitCustomEvents")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "List of exit events configured for the asset. This is a read-only, auto-generated field and only applicable to a rich media asset."]
    pub exit_custom_events:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CreativeCustomEvent>>>,
    #[serde(rename = "id")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "True if the uploaded asset is a rich media asset. This is a read-only, auto-generated field."]
    pub rich_media: ::std::option::Option<::std::primitive::bool>,
    #[serde(rename = "timerCustomEvents")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "List of timer events configured for the asset. This is a read-only, auto-generated field and only applicable to a rich media asset."]
    pub timer_custom_events:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CreativeCustomEvent>>>,
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Experimental feature (no support provided) A custom event represents a third party impression, a third party click, an annotation on a first party impression, or an annotation on a first party click."]
pub struct CustomEvent {
    ...
    pub annotate_click_event: ::std::option::Option<::std::boxed::Box<CustomEventClickAnnotation>>,
    #[serde(rename = "annotateImpressionEvent")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Annotate an impression. This field is mutually exclusive with insertEvent and annotateClickEvent. This or insertEvent and annotateClickEvent is a required field."]
    pub annotate_impression_event:
        ::std::option::Option<::std::boxed::Box<CustomEventImpressionAnnotation>>,
    #[serde(rename = "customVariables")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Custom variables associated with the event."]
    pub custom_variables: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CustomVariable>>>,
    #[serde(rename = "eventType")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The type of event. If INSERT, the fields in insertEvent need to be populated. If ANNOTATE, the fields in either annotateClickEvent or annotateImpressionEvent need to be populated."]
    pub event_type: ::std::option::Option<CustomEventEventTypeEnum>,
    #[serde(rename = "floodlightConfigurationId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Floodlight configuration ID of the advertiser the event is linked to. This is a required field."]
    pub floodlight_configuration_id: ::std::option::Option<::std::string::String>,
    ...
    pub insert_event: ::std::option::Option<::std::boxed::Box<CustomEventInsert>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEvent\"."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "ordinal")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The ordinal of this custom event. This is a required field."]
    pub ordinal: ::std::option::Option<::std::string::String>,
    #[serde(rename = "timestampMicros")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The timestamp of this custom event, in Unix epoch micros. This is a required field."]
    pub timestamp_micros: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "The type of event. If INSERT, the fields in insertEvent need to be populated. If ANNOTATE, the fields in either annotateClickEvent or annotateImpressionEvent need to be populated."]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Annotate a click event."]
pub struct CustomEventClickAnnotation {
    #[serde(rename = "gclid")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The Google click ID. Use this field to annotate the click associated with the gclid."]
    pub gclid: ::std::option::Option<::std::string::String>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEventClickAnnotation\"."]
    pub kind: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "The error code and description for a custom event that failed to insert."]
pub struct CustomEventError {
    #[serde(rename = "code")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The error code."]
    pub code: ::std::option::Option<CustomEventErrorCodeEnum>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEventError\"."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "message")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A description of the error."]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Annotate an impression."]
pub struct CustomEventImpressionAnnotation {
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEventImpressionAnnotation\"."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "pathImpressionId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The path impression ID. Use this field to annotate the impression associated with the pathImpressionId."]
    pub path_impression_id: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Custom event to be inserted."]
pub struct CustomEventInsert {
    #[serde(rename = "cmDimensions")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Campaign Manager dimensions associated with the event."]
    pub cm_dimensions: ::std::option::Option<::std::boxed::Box<CampaignManagerIds>>,
    #[serde(rename = "dv3Dimensions")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "DV360 dimensions associated with the event."]
    pub dv3_dimensions: ::std::option::Option<::std::boxed::Box<Dv3Ids>>,
    #[serde(rename = "insertEventType")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The type of event to insert."]
    pub insert_event_type: ::std::option::Option<CustomEventInsertInsertEventTypeEnum>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEventInsert\"."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "matchId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The match ID field. A match ID is your own first-party identifier that has been synced with Google using the match ID feature in Floodlight. This field is mutually exclusive with mobileDeviceId, and at least one of the two fields is required."]
    pub match_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "mobileDeviceId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The mobile device ID. This field is mutually exclusive with matchId, and at least one of the two fields is required."]
    pub mobile_device_id: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "The type of event to insert."]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "The original custom event that was inserted and whether there were any errors."]
pub struct CustomEventStatus {
    #[serde(rename = "customEvent")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The original custom event that was inserted."]
    pub custom_event: ::std::option::Option<::std::boxed::Box<CustomEvent>>,
    #[serde(rename = "errors")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of errors related to this custom event."]
    pub errors: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CustomEventError>>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEventStatus\"."]
    pub kind: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Insert Custom Events Request."]
pub struct CustomEventsBatchInsertRequest {
    #[serde(rename = "customEvents")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The set of custom events to insert."]
    pub custom_events: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CustomEvent>>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEventsBatchInsertRequest\"."]
    pub kind: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Insert Custom Events Response."]
pub struct CustomEventsBatchInsertResponse {
    #[serde(rename = "hasFailures")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Indicates that some or all custom events failed to insert."]
    pub has_failures: ::std::option::Option<::std::primitive::bool>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customEventsBatchInsertResponse\"."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "status")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The insert status of each custom event. Statuses are returned in the same order that conversions are inserted."]
    pub status: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CustomEventStatus>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct CustomVariable {
    #[serde(rename = "index")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The index of the custom variable."]
    pub index: ::std::option::Option<::std::string::String>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#customVariable\"."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "value")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The value of the custom variable. The length of string must not exceed 50 characters."]
    pub value: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "DV360 IDs related to the custom event."]
pub struct Dv3Ids {
    #[serde(rename = "dvCampaignId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Campaign ID for DV360."]
    pub dv_campaign_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "dvCreativeId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Creative ID for DV360."]
    pub dv_creative_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "dvInsertionOrderId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Insertion Order ID for DV360."]
    pub dv_insertion_order_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "dvLineItemId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Line Item ID for DV360."]
    pub dv_line_item_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "dvSiteId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Site ID for DV360."]
    pub dv_site_id: ::std::option::Option<::std::string::String>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies what kind of resource this is. Value: the fixed string \"dfareporting#dV3Ids\"."]
    pub kind: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Represents a Disjunctive Match Statement resource, which is a conjunction (and) of disjunctive (or) boolean statements."]
pub struct DisjunctiveMatchStatement {
    #[serde(rename = "eventFilters")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The event filters contained within this disjunctive match statement."]
    pub event_filters: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<EventFilter>>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The kind of resource this is, in this case dfareporting#disjunctiveMatchStatement."]
    pub kind: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Represents a DfaReporting event filter."]
pub struct EventFilter {
    #[serde(rename = "dimensionFilter")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The dimension filter contained within this EventFilter."]
    pub dimension_filter: ::std::option::Option<::std::boxed::Box<PathReportDimensionValue>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The kind of resource this is, in this case dfareporting#eventFilter."]
    pub kind: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct FloodlightActivity {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Whether the activity is enabled for attribution."]
    pub attribution_enabled: ::std::option::Option<::std::primitive::bool>,
    ...
    #[serde(rename = "status")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The status of the activity. This can only be set to ACTIVE or ARCHIVED_AND_DISABLED. The ARCHIVED status is no longer supported and cannot be set for Floodlight activities. The DISABLED_POLICY status indicates that a Floodlight activity is violating Google policy. Contact your account manager for more information."]
    pub status: ::std::option::Option<FloodlightActivityStatusEnum>,
    #[serde(rename = "subaccountId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Online Behavioral Advertiser icon."]
pub struct ObaIcon {
    #[serde(rename = "iconClickThroughUrl")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "URL to redirect to when an OBA icon is clicked."]
    pub icon_click_through_url: ::std::option::Option<::std::string::String>,
    #[serde(rename = "iconClickTrackingUrl")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "URL to track click when an OBA icon is clicked."]
    pub icon_click_tracking_url: ::std::option::Option<::std::string::String>,
    #[serde(rename = "iconViewTrackingUrl")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "URL to track view when an OBA icon is clicked."]
    pub icon_view_tracking_url: ::std::option::Option<::std::string::String>,
    #[serde(rename = "program")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Identifies the industry initiative that the icon supports. For example, AdChoices."]
    pub program: ::std::option::Option<::std::string::String>,
    #[serde(rename = "resourceUrl")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "OBA icon resource URL. Campaign Manager only supports image and JavaScript icons. Learn more"]
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "OBA icon x coordinate position. Accepted values are left or right."]
    pub x_position: ::std::option::Option<::std::string::String>,
    #[serde(rename = "yPosition")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "OBA icon y coordinate position. Accepted values are top or bottom."]
    pub y_position: ::std::option::Option<::std::string::String>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Object Filter."]
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Represents a DfaReporting path filter."]
pub struct PathFilter {
    #[serde(rename = "eventFilters")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Event filters in path report."]
    pub event_filters: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<EventFilter>>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The kind of resource this is, in this case dfareporting#pathFilter."]
    pub kind: ::std::option::Option<::std::string::String>,
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Represents fields that are compatible to be selected for a report of type \"PATH\"."]
pub struct PathReportCompatibleFields {
    ...
    pub channel_groupings: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Dimension>>>,
    #[serde(rename = "dimensions")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Dimensions which are compatible to be selected in the \"dimensions\" section of the report."]
    pub dimensions: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Dimension>>>,
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The kind of resource this is, in this case dfareporting#pathReportCompatibleFields."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "metrics")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Metrics which are compatible to be selected in the \"metricNames\" section of the report."]
    ...
    pub path_filters: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Dimension>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "Represents a PathReportDimensionValue resource."]
pub struct PathReportDimensionValue {
    ...
    #[serde(rename = "kind")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The kind of resource this is, in this case dfareporting#pathReportDimensionValue."]
    pub kind: ::std::option::Option<::std::string::String>,
    #[serde(rename = "matchType")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Determines how the 'value' field is matched when filtering. If not specified, defaults to EXACT. If set to WILDCARD_EXPRESSION, '*' is allowed as a placeholder for variable length character sequences, and it can be escaped with a backslash. Note, only paid search dimensions ('dfa:paidSearch*') allow a matchType other than EXACT."]
    pub match_type: ::std::option::Option<PathReportDimensionValueMatchTypeEnum>,
    #[serde(rename = "values")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The possible values of the dimension."]
...
pub struct Report {
    ...
    pub path_attribution_criteria: ::std::option::Option<ReportPathAttributionCriteria>,
    #[serde(rename = "pathCriteria")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The report criteria for a report of type \"PATH\"."]
    pub path_criteria: ::std::option::Option<ReportPathCriteria>,
...
pub struct ReportPathAttributionCriteria {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Channel Grouping."]
    pub custom_channel_grouping: ::std::option::Option<::std::boxed::Box<ChannelGrouping>>,
    #[serde(rename = "dateRange")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The date range this report should be run for."]
    pub date_range: ::std::option::Option<::std::boxed::Box<DateRange>>,
...
pub struct SiteVideoSettings {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Whether OBA icons are enabled for this placement."]
    pub oba_enabled: ::std::option::Option<::std::primitive::bool>,
    #[serde(rename = "obaSettings")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Settings for the OBA icon of video creatives served to this site. This will act as default for new placements created under this site."]
    pub oba_settings: ::std::option::Option<::std::boxed::Box<ObaIcon>>,
    #[serde(rename = "orientation")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct VideoSettings {
    ...
    #[serde(rename = "obaSettings")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Settings for the OBA icon of video creatives served to this placement. If this object is provided, the creative-level OBA settings will be overridden."]
    pub oba_settings: ::std::option::Option<::std::boxed::Box<ObaIcon>>,
    #[serde(rename = "orientation")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
