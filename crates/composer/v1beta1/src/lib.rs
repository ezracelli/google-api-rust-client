...
pub mod schemas {
    ...
    #[doc = "The encryption options for the Composer environment and its dependencies."]
    ...
    pub struct EnvironmentConfig {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Optional. The encryption options for the Composer environment and its dependencies. Cannot be updated."]
    ...
    #[doc = "Configuration for controlling how IPs are allocated in the GKE cluster."]
    pub struct IpAllocationPolicy {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Optional. The name of the cluster's secondary range used to allocate IP addresses to pods. Specify either `cluster_secondary_range_name` or `cluster_ipv4_cidr_block` but not both. This field is applicable only when `use_ip_aliases` is true."]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Optional. The name of the services' secondary range used to allocate IP addresses to the cluster. Specify either `services_secondary_range_name` or `services_ipv4_cidr_block` but not both. This field is applicable only when `use_ip_aliases` is true."]
    ...
    #[doc = "The configuration settings for Cloud Composer maintenance window. The following example: { \"startTime\":\"2019-08-01T01:00:00Z\" \"endTime\":\"2019-08-01T07:00:00Z\" \"recurrence\":\"FREQ=WEEKLY;BYDAY=TU,WE\" } would define a maintenance window between 01 and 07 hours UTC during each Tuesday and Wednesday."]
    pub struct MaintenanceWindow {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "endTime")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Required. Maintenance window end time. It is used only to calculate the duration of the maintenance window. The value for end_time must be in the future, relative to `start_time`."]
    ...
    impl RestartWebServerRequest {
        pub fn builder() -> RestartWebServerRequestBuilder {
            RestartWebServerRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
