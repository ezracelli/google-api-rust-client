...
pub mod schemas {
    ...
    #[doc = "Generated advice about this change, used for providing more information about how a change will affect the existing service."]
    pub struct Advice {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    #[doc = "Change report associated with a particular service configuration. It contains a list of ConfigChanges based on the comparison between two service configurations."]
    pub struct ChangeReport {
        ...
        pub config_changes: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ConfigChange>>>,
    }
    impl ChangeReport {
        pub fn builder() -> ChangeReportBuilder {
            ChangeReportBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Output generated from semantically comparing two versions of a service configuration. Includes detailed information about a field that have changed with applicable advice about potential consequences for the change, such as backwards-incompatibility."]
    pub struct ConfigChange {
        ...
        pub advices: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Advice>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "changeType")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The type for this change, either ADDED, REMOVED, or MODIFIED."]
        pub change_type: ::std::option::Option<ConfigChangeChangeTypeEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl ConfigChange {
        pub fn builder() -> ConfigChangeBuilder {
            ConfigChangeBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "The type for this change, either ADDED, REMOVED, or MODIFIED."]
    pub enum ConfigChangeChangeTypeEnum {
    ...
    impl ::std::default::Default for ConfigChangeChangeTypeEnum {
        fn default() -> Self {
    ...
    #[doc = "Generic specification of a source configuration file"]
    pub struct ConfigFile {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "fileContents")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The bytes that constitute the file."]
        pub file_contents: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub file_type: ::std::option::Option<ConfigFileFileTypeEnum>,
    }
    impl ConfigFile {
    ...
    impl ::std::default::Default for ConfigFileFileTypeEnum {
        fn default() -> Self {
    ...
    #[doc = "Represents a service configuration with its name and id."]
    ...
    impl ConfigRef {
        pub fn builder() -> ConfigRefBuilder {
            ConfigRefBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Represents a source file which is used to generate the service configuration defined by `google.api.Service`."]
    pub struct ConfigSource {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "files")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Set of source configuration files that are used to generate a service configuration (`google.api.Service`)."]
        pub files: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ConfigFile>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "id")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[doc = "Strategy used to delete a service. This strategy is a placeholder only used by the system generated rollout to delete a service."]
    pub struct DeleteServiceStrategy {}
    impl DeleteServiceStrategy {
        pub fn builder() -> DeleteServiceStrategyBuilder {
            DeleteServiceStrategyBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Represents a diagnostic message (error or warning)"]
    pub struct Diagnostic {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "kind")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The kind of diagnostic information provided."]
        pub kind: ::std::option::Option<DiagnosticKindEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl ::std::default::Default for DiagnosticKindEnum {
        fn default() -> Self {
            Self::Warning
        }
    }
    ...
    #[doc = "Operation payload for DisableService method."]
    ...
    #[doc = "Request message for EnableService method."]
    pub struct EnableServiceRequest {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "consumerId")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Required. The identity of consumer resource which service enablement will be applied to. The Google Service Management implementation accepts the following forms: - \"project:\" Note: this is made compatible with google.api.servicecontrol.v1.Operation.consumer_id."]
        pub consumer_id: ::std::option::Option<::std::string::String>,
    }
    ...
    #[doc = "Operation payload for EnableService method."]
    ...
    #[doc = "Encapsulation of flow-specific error details for debugging. Used as a details field on an error Status, not intended for external use."]
    pub struct FlowErrorDetails {
        ...
        pub flow_step_id: ::std::option::Option<::std::string::String>,
    }
    impl FlowErrorDetails {
        pub fn builder() -> FlowErrorDetailsBuilder {
            FlowErrorDetailsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Request message for GenerateConfigReport method."]
    ...
    impl GenerateConfigReportRequest {
        pub fn builder() -> GenerateConfigReportRequestBuilder {
            GenerateConfigReportRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for GenerateConfigReport method."]
    pub struct GenerateConfigReportResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "changeReports")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "list of ChangeReport, each corresponding to comparison between two service configurations."]
        pub change_reports: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ChangeReport>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl GenerateConfigReportResponse {
        pub fn builder() -> GenerateConfigReportResponseBuilder {
            GenerateConfigReportResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message for ListServiceConfigs method."]
    pub struct ListServiceConfigsResponse {
        ...
        pub service_configs: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Service>>>,
    }
    impl ListServiceConfigsResponse {
        pub fn builder() -> ListServiceConfigsResponseBuilder {
            ListServiceConfigsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for ListServiceRollouts method."]
    pub struct ListServiceRolloutsResponse {
        ...
        pub rollouts: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Rollout>>>,
    }
    impl ListServiceRolloutsResponse {
        pub fn builder() -> ListServiceRolloutsResponseBuilder {
            ListServiceRolloutsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for `ListServices` method."]
    pub struct ListServicesResponse {
        ...
        pub services: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ManagedService>>>,
    }
    ...
    #[doc = "The full representation of a Service that is managed by Google Service Management."]
    pub struct ManagedService {
        ...
        #[serde(rename = "serviceName")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The name of the service. See the [overview](/service-management/overview) for naming requirements."]
        pub service_name: ::std::option::Option<::std::string::String>,
    }
    impl ManagedService {
        pub fn builder() -> ManagedServiceBuilder {
            ManagedServiceBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "The metadata associated with a long running operation resource."]
    pub struct OperationMetadata {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "progressPercentage")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Percentage of completion of this operation, ranging from 0 to 100."]
        pub progress_percentage: ::std::option::Option<::std::primitive::i64>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    #[doc = "Defines a proto annotation that describes a string field that refers to an API resource."]
    pub struct ResourceReference {
        ...
        pub child_type: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "type")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl ResourceReference {
        pub fn builder() -> ResourceReferenceBuilder {
            ResourceReferenceBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "A rollout resource that defines how service configuration versions are pushed to control plane systems. Typically, you create a new version of the service config, and then create a Rollout to push the service config."]
    pub struct Rollout {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "This field is deprecated and will be deleted. Please remove usage of this field."]
        pub created_by: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "deleteServiceStrategy")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The strategy associated with a rollout to delete a `ManagedService`. Readonly."]
        pub delete_service_strategy:
            ::std::option::Option<::std::boxed::Box<DeleteServiceStrategy>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub rollout_id: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "serviceName")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        pub status: ::std::option::Option<RolloutStatusEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "trafficPercentStrategy")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Google Service Control selects service configurations based on traffic percentage."]
        pub traffic_percent_strategy:
            ::std::option::Option<::std::boxed::Box<TrafficPercentStrategy>>,
    }
    impl Rollout {
        pub fn builder() -> RolloutBuilder {
            RolloutBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "The status of this rollout. Readonly. In case of a failed rollout, the system will automatically rollback to the current Rollout version. Readonly."]
    pub enum RolloutStatusEnum {
    ...
    impl ::std::default::Default for RolloutStatusEnum {
        fn default() -> Self {
            Self::RolloutStatusUnspecified
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Represents the status of one operation step."]
    pub struct Step {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "description")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The status code."]
        pub status: ::std::option::Option<StepStatusEnum>,
    }
    impl Step {
    ...
    impl ::std::default::Default for StepStatusEnum {
        fn default() -> Self {
    ...
    impl SubmitConfigSourceRequest {
        pub fn builder() -> SubmitConfigSourceRequestBuilder {
            SubmitConfigSourceRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for SubmitConfigSource method."]
    pub struct SubmitConfigSourceResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "serviceConfig")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The generated service configuration."]
        pub service_config: ::std::option::Option<::std::boxed::Box<Service>>,
    }
    impl SubmitConfigSourceResponse {
        pub fn builder() -> SubmitConfigSourceResponseBuilder {
            SubmitConfigSourceResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl TrafficPercentStrategy {
        pub fn builder() -> TrafficPercentStrategyBuilder {
            TrafficPercentStrategyBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message for UndeleteService method."]
    pub struct UndeleteServiceResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "service")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Revived service resource."]
        pub service: ::std::option::Option<::std::boxed::Box<ManagedService>>,
    }
    impl UndeleteServiceResponse {
        pub fn builder() -> UndeleteServiceResponseBuilder {
            UndeleteServiceResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
