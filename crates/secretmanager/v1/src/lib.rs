...
pub mod schemas {
    ...
    impl AccessSecretVersionResponse {
        pub fn builder() -> AccessSecretVersionResponseBuilder {
            AccessSecretVersionResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl AddSecretVersionRequest {
        pub fn builder() -> AddSecretVersionRequestBuilder {
            AddSecretVersionRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct Automatic {
        ...
        pub customer_managed_encryption:
            ::std::option::Option<::std::boxed::Box<CustomerManagedEncryption>>,
    }
    impl Automatic {
        pub fn builder() -> AutomaticBuilder {
    ...
    #[doc = "The replication status of a SecretVersion using automatic replication. Only populated if the parent Secret has an automatic replication policy."]
    pub struct AutomaticStatus {
        ...
        pub customer_managed_encryption:
            ::std::option::Option<::std::boxed::Box<CustomerManagedEncryptionStatus>>,
    }
    impl AutomaticStatus {
        pub fn builder() -> AutomaticStatusBuilder {
            AutomaticStatusBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Configuration for encrypting secret payloads using customer-managed encryption keys (CMEK)."]
    ...
    impl CustomerManagedEncryption {
        pub fn builder() -> CustomerManagedEncryptionBuilder {
            CustomerManagedEncryptionBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Describes the status of customer-managed encryption."]
    ...
    impl CustomerManagedEncryptionStatus {
        pub fn builder() -> CustomerManagedEncryptionStatusBuilder {
            CustomerManagedEncryptionStatusBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl DestroySecretVersionRequest {
        pub fn builder() -> DestroySecretVersionRequestBuilder {
            DestroySecretVersionRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl DisableSecretVersionRequest {
        pub fn builder() -> DisableSecretVersionRequestBuilder {
            DisableSecretVersionRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl EnableSecretVersionRequest {
        pub fn builder() -> EnableSecretVersionRequestBuilder {
            EnableSecretVersionRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListSecretVersionsResponse {
        pub fn builder() -> ListSecretVersionsResponseBuilder {
            ListSecretVersionsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListSecretsResponse {
        pub fn builder() -> ListSecretsResponseBuilder {
            ListSecretsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Describes the status of a user-managed replica for the SecretVersion."]
    ...
    impl ReplicaStatus {
        pub fn builder() -> ReplicaStatusBuilder {
            ReplicaStatusBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "A policy that defines the replication and encryption configuration of data."]
    ...
    impl Replication {
        pub fn builder() -> ReplicationBuilder {
            ReplicationBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "The replication status of a SecretVersion."]
    pub struct ReplicationStatus {
        ...
        pub automatic: ::std::option::Option<::std::boxed::Box<AutomaticStatus>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "userManaged")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        pub user_managed: ::std::option::Option<::std::boxed::Box<UserManagedStatus>>,
    }
    impl ReplicationStatus {
        pub fn builder() -> ReplicationStatusBuilder {
            ReplicationStatusBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "A secret payload resource in the Secret Manager API. This contains the sensitive secret payload that is associated with a SecretVersion."]
    ...
    impl SecretPayload {
        pub fn builder() -> SecretPayloadBuilder {
            SecretPayloadBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct SecretVersion {
        ...
        pub replication_status: ::std::option::Option<::std::boxed::Box<ReplicationStatus>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "state")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl SecretVersion {
        pub fn builder() -> SecretVersionBuilder {
            SecretVersionBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Output only. The current state of the SecretVersion."]
    ...
    impl ::std::default::Default for SecretVersionStateEnum {
        fn default() -> Self {
    ...
    #[doc = "A Pub/Sub topic which SM will publish to when control plane events occur on this secret."]
    pub struct Topic {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl UserManaged {
        pub fn builder() -> UserManagedBuilder {
            UserManagedBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "The replication status of a SecretVersion using user-managed replication. Only populated if the parent Secret has a user-managed replication policy."]
    pub struct UserManagedStatus {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "replicas")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The list of replica statuses for the SecretVersion."]
        pub replicas: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ReplicaStatus>>>,
    }
    impl UserManagedStatus {
        pub fn builder() -> UserManagedStatusBuilder {
            UserManagedStatusBuilder::default()
        }
    }
}
