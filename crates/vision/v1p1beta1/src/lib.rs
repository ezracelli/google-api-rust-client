...
pub struct GoogleCloudVisionV1p1beta1AnnotateFileRequest {
    ...
    pub features: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudVisionV1p1beta1Feature>>,
    >,
    #[serde(rename = "imageContext")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Additional context that may accompany the image(s) in the file."]
    pub image_context:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1ImageContext>>,
    #[serde(rename = "inputConfig")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudVisionV1p1beta1AnnotateImageRequest {
    ...
    pub image: ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1Image>>,
    #[serde(rename = "imageContext")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest {
    ...
    pub requests: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudVisionV1p1beta1AsyncAnnotateFileRequest>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudVisionV1p1beta1AsyncBatchAnnotateImagesRequest {
    ...
    pub requests: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudVisionV1p1beta1AnnotateImageRequest>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudVisionV1p1beta1BatchAnnotateFilesRequest {
    ...
    pub requests: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudVisionV1p1beta1AnnotateFileRequest>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse {
    ...
    #[doc = "The list of file annotation responses, each response corresponding to each AnnotateFileRequest in BatchAnnotateFilesRequest."]
    pub responses: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudVisionV1p1beta1AnnotateFileResponse>>,
    >,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudVisionV1p1beta1Feature {
    ...
    pub _type: ::std::option::Option<GoogleCloudVisionV1p1beta1FeatureTypeEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "The feature type."]
pub enum GoogleCloudVisionV1p1beta1FeatureTypeEnum {
...
pub struct GoogleCloudVisionV1p1beta1Image {
    ...
    pub source: ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1ImageSource>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudVisionV1p1beta1ImageContext {
    ...
    pub crop_hints_params:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1CropHintsParams>>,
    ...
    #[doc = "Not used."]
    pub lat_long_rect:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1LatLongRect>>,
    #[serde(rename = "productSearchParams")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Parameters for product search."]
    pub product_search_params:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1ProductSearchParams>>,
    #[serde(rename = "textDetectionParams")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Parameters for text detection and document text detection."]
    pub text_detection_params:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1TextDetectionParams>>,
    #[serde(rename = "webDetectionParams")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Parameters for web detection."]
    pub web_detection_params:
        ::std::option::Option<::std::boxed::Box<GoogleCloudVisionV1p1beta1WebDetectionParams>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
