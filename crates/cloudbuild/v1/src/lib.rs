                ...
                pub mod methods {
                    pub mod create {
                        ...
                        pub struct QueryParameters {
                            ...
                            #[serde(rename = "parent")]
                            #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                            #[doc = "The parent resource where this build will be created. Format: `projects/{project}/locations/{location}`"]
                    ...
                    pub mod get {
                        ...
                        pub struct QueryParameters {
                            ...
                            #[serde(rename = "name")]
                            #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                            #[doc = "The name of the `Build` to retrieve. Format: `projects/{project}/locations/{location}/builds/{build}`"]
                    ...
                    pub mod list {
                        ...
                        pub struct QueryParameters {
                            ...
                            #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                            #[doc = "The page token for the next page of Builds. If unspecified, the first page of results is returned. If the token is rejected for any reason, INVALID_ARGUMENT will be thrown. In this case, the token should be discarded, and pagination should be restarted from the first page of results. See https://google.aip.dev/158 for more."]
                            ...
                            #[serde(rename = "parent")]
                            #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                            #[doc = "The parent of the collection of `Builds`. Format: `projects/{project}/locations/location`"]
                            pub parent: ::std::option::Option<::std::string::String>,
                        }
                        impl QueryParameters {
                            pub fn builder() -> QueryParametersBuilder {
                        ...
                        pub mod methods {
                            pub mod create {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Required. ID of the project."]
                ...
                pub mod methods {
                    ...
                    pub mod webhook {
                        ...
                        pub struct QueryParameters {
                            ...
                            #[serde(rename = "secret")]
                            #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                            #[doc = "Secret token used for authorization if an OAuth token isn't provided."]
...
pub mod schemas {
    ...
    #[doc = "Configuration for an automated build in response to source repository changes."]
    pub struct BuildTrigger {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "If true, the trigger will never automatically execute a build."]
        pub disabled: ::std::option::Option<::std::primitive::bool>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "filename")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Path, from the source root, to a file whose contents is used for the template."]
        pub filename: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "github")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "GitHubEventsConfig describes the configuration of a trigger that creates a build whenever a GitHub event is received. Mutually exclusive with `trigger_template`."]
        pub github: ::std::option::Option<::std::boxed::Box<GitHubEventsConfig>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "id")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "ignored_files and included_files are file glob matches using https://golang.org/pkg/path/filepath/#Match extended with support for \"**\". If ignored_files and changed files are both empty, then they are not used to determine whether or not to trigger a build. If ignored_files is not empty, then we ignore any files that match any of the ignored_file globs. If the change has no files that are outside of the ignored_files globs, then we do not trigger a build."]
        pub ignored_files: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub included_files: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "User-assigned name of the trigger. Must be unique within the project. Trigger names must meet the following requirements: + They must contain only alphanumeric characters and dashes. + They can be 1-64 characters long. + They must begin and end with an alphanumeric character."]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "substitutions")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Substitutions for Build resource. The keys must match the following regular expression: `^_[A-Z0-9_]+$`."]
        pub substitutions:
            ::std::option::Option<::std::collections::BTreeMap<String, ::std::string::String>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "tags")]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Template describing the types of source changes to trigger a build. Branch and tag names in trigger templates are interpreted as regular expressions. Any branch or tag change that matches that regular expression will trigger a build. Mutually exclusive with `github`."]
        pub trigger_template: ::std::option::Option<::std::boxed::Box<RepoSource>>,
    }
    impl BuildTrigger {
        pub fn builder() -> BuildTriggerBuilder {
    ...
    #[doc = "Request to cancel an ongoing build."]
    pub struct CancelBuildRequest {
        ...
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The name of the `Build` to cancel. Format: `projects/{project}/locations/{location}/builds/{build}`"]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "projectId")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[doc = "GitHubEventsConfig describes the configuration of a trigger that creates a build whenever a GitHub event is received. This message is experimental."]
    pub struct GitHubEventsConfig {
        ...
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Name of the repository. For example: The name for https://github.com/googlecloudplatform/cloud-builders is \"cloud-builders\"."]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "owner")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Owner of the repository. For example: The owner for https://github.com/googlecloudplatform/cloud-builders is \"googlecloudplatform\"."]
        pub owner: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "pullRequest")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "filter to match changes in pull requests."]
        pub pull_request: ::std::option::Option<::std::boxed::Box<PullRequestFilter>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "push")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "filter to match changes in refs like branches, tags."]
        pub push: ::std::option::Option<::std::boxed::Box<PushFilter>>,
    }
    impl GitHubEventsConfig {
        pub fn builder() -> GitHubEventsConfigBuilder {
            GitHubEventsConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response containing existing `BuildTriggers`."]
    pub struct ListBuildTriggersResponse {
        ...
        pub triggers: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<BuildTrigger>>>,
    }
    impl ListBuildTriggersResponse {
        pub fn builder() -> ListBuildTriggersResponseBuilder {
            ListBuildTriggersResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response including listed builds."]
    pub struct ListBuildsResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "builds")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Builds will be sorted by `create_time`, descending."]
        pub builds: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Build>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "nextPageToken")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Token to receive the next page of results. This will be absent if the end of the response list has been reached."]
        pub next_page_token: ::std::option::Option<::std::string::String>,
    }
    impl ListBuildsResponse {
        pub fn builder() -> ListBuildsResponseBuilder {
            ListBuildsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "PullRequestFilter contains filter properties for matching GitHub Pull Requests."]
    pub struct PullRequestFilter {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "branch")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Regex of branches to match. The syntax of the regular expressions accepted is the syntax accepted by RE2 and described at https://github.com/google/re2/wiki/Syntax"]
        pub branch: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "commentControl")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Configure builds to run whether a repository owner or collaborator need to comment `/gcbrun`."]
        pub comment_control: ::std::option::Option<PullRequestFilterCommentControlEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl PullRequestFilter {
        pub fn builder() -> PullRequestFilterBuilder {
            PullRequestFilterBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Configure builds to run whether a repository owner or collaborator need to comment `/gcbrun`."]
    pub enum PullRequestFilterCommentControlEnum {
        ...
        #[doc = "Enforce that repository owners or collaborators must comment on Pull Requests before builds are triggered."]
        CommentsEnabled,
        #[serde(rename = "COMMENTS_ENABLED_FOR_EXTERNAL_CONTRIBUTORS_ONLY")]
        #[doc = "Enforce that repository owners or collaborators must comment on external contributors' Pull Requests before builds are triggered."]
        CommentsEnabledForExternalContributorsOnly,
    }
    impl ::std::default::Default for PullRequestFilterCommentControlEnum {
        fn default() -> Self {
    ...
    #[doc = "Push contains filter properties for matching GitHub git pushes."]
    pub struct PushFilter {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "branch")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Regexes matching branches to build. The syntax of the regular expressions accepted is the syntax accepted by RE2 and described at https://github.com/google/re2/wiki/Syntax"]
        pub branch: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "invertRegex")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "When true, only trigger a build if the revision regex does NOT match the git_ref regex."]
        pub invert_regex: ::std::option::Option<::std::primitive::bool>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "tag")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Regexes matching tags to build. The syntax of the regular expressions accepted is the syntax accepted by RE2 and described at https://github.com/google/re2/wiki/Syntax"]
        pub tag: ::std::option::Option<::std::string::String>,
    }
    impl PushFilter {
        pub fn builder() -> PushFilterBuilder {
            PushFilterBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "ReceiveTriggerWebhookResponse [Experimental] is the response object for the ReceiveTriggerWebhook method."]
    pub struct ReceiveTriggerWebhookResponse {}
    impl ReceiveTriggerWebhookResponse {
        pub fn builder() -> ReceiveTriggerWebhookResponseBuilder {
            ReceiveTriggerWebhookResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Specifies a build to retry."]
    pub struct RetryBuildRequest {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "id")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Required. Build ID of the original build."]
        pub id: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The name of the `Build` to retry. Format: `projects/{project}/locations/{location}/builds/{build}`"]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "projectId")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl RetryBuildRequest {
        pub fn builder() -> RetryBuildRequestBuilder {
            RetryBuildRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
