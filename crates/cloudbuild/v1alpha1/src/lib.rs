...
pub mod schemas {
    ...
    #[doc = "Network describes the GCP network used to create workers in."]
    pub struct Network {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    pub struct WorkerPool {
        ...
        pub regions: ::std::option::Option<::std::vec::Vec<WorkerPoolRegionsEnum>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub status: ::std::option::Option<WorkerPoolStatusEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    pub enum WorkerPoolRegionsEnum {
    ...
    impl ::std::default::Default for WorkerPoolRegionsEnum {
        fn default() -> Self {
    ...
    impl ::std::default::Default for WorkerPoolStatusEnum {
        fn default() -> Self {
