...
pub mod schemas {
    ...
    impl GoogleCloudRedisV1LocationMetadata {
        pub fn builder() -> GoogleCloudRedisV1LocationMetadataBuilder {
            GoogleCloudRedisV1LocationMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleCloudRedisV1OperationMetadata {
        pub fn builder() -> GoogleCloudRedisV1OperationMetadataBuilder {
            GoogleCloudRedisV1OperationMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleCloudRedisV1ZoneMetadata {
        pub fn builder() -> GoogleCloudRedisV1ZoneMetadataBuilder {
            GoogleCloudRedisV1ZoneMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
