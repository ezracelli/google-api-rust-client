...
pub struct Creative {
    ...
    pub ad_technology_providers: ::std::option::Option<::std::boxed::Box<AdTechnologyProviders>>,
...
pub struct CreativeSpecification {
    ...
    pub creative_companion_sizes: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<AdSize>>>,
...
pub struct DeliveryControl {
    ...
    pub creative_blocking_level: ::std::option::Option<DeliveryControlCreativeBlockingLevelEnum>,
...
pub struct InventorySizeTargeting {
    ...
    pub excluded_inventory_sizes: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<AdSize>>>,
    #[serde(rename = "targetedInventorySizes")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "A list of inventory sizes to be included."]
    pub targeted_inventory_sizes: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<AdSize>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct ListBidMetricsResponse {
    ...
    pub bid_metrics_rows: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<BidMetricsRow>>>,
...
pub struct ListBidResponsesWithoutBidsResponse {
    ...
    pub bid_response_without_bids_status_rows:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<BidResponseWithoutBidsStatusRow>>>,
    #[serde(rename = "nextPageToken")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct ListNonBillableWinningBidsResponse {
    ...
    pub non_billable_winning_bid_status_rows:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<NonBillableWinningBidStatusRow>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct MarketplaceTargeting {
    ...
    pub inventory_size_targeting: ::std::option::Option<::std::boxed::Box<InventorySizeTargeting>>,
...
pub struct ServingRestriction {
    ...
    pub disapproval_reasons: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Disapproval>>>,
    #[serde(rename = "status")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct TechnologyTargeting {
    ...
    pub device_capability_targeting: ::std::option::Option<::std::boxed::Box<CriteriaTargeting>>,
