                        ...
                        pub mod methods {
                            pub mod create {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "The globally unique identifier of the database instance."]
                                    ...
                                    #[doc = "When set to true, the request will be validated but not submitted."]
                                    pub validate_only:
                            ...
                            pub mod list {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "The maximum number of database instances to return in the response. The server may return fewer than this at its discretion. If no value is specified (or too large a value is specified), then the server will impose its own limit."]
                                    ...
                                    #[doc = "Token returned from a previous call to `ListDatabaseInstances` indicating where in the set of database instances to resume listing."]
...
pub mod schemas {
    ...
    impl ::std::default::Default for DatabaseInstanceTypeEnum {
        fn default() -> Self {
            Self::DatabaseInstanceTypeUnspecified
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl DisableDatabaseInstanceRequest {
        pub fn builder() -> DisableDatabaseInstanceRequestBuilder {
            DisableDatabaseInstanceRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListDatabaseInstancesResponse {
        pub fn builder() -> ListDatabaseInstancesResponseBuilder {
            ListDatabaseInstancesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ReenableDatabaseInstanceRequest {
        pub fn builder() -> ReenableDatabaseInstanceRequestBuilder {
            ReenableDatabaseInstanceRequestBuilder::default()
        }
    }
}
