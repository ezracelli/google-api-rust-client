...
pub mod schemas {
    ...
    pub enum InstanceTypeEnum {
        ...
        #[doc = "Enterprise Data Fusion instance. In Enterprise type, the user will have all features available, such as support for streaming pipelines, unlimited number of concurrent pipelines, etc."]
        Enterprise,
    ...
    pub struct NetworkConfig {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The IP range in CIDR notation to use for the managed Data Fusion instance nodes. This range must not overlap with any other ranges used in the Data Fusion instance network."]
    ...
    #[doc = "Request message for RemoveIamPolicy method."]
    pub struct RemoveIamPolicyRequest {}
    impl RemoveIamPolicyRequest {
        pub fn builder() -> RemoveIamPolicyRequestBuilder {
            RemoveIamPolicyRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for RemoveIamPolicy method."]
    pub struct RemoveIamPolicyResponse {}
    impl RemoveIamPolicyResponse {
        pub fn builder() -> RemoveIamPolicyResponseBuilder {
            RemoveIamPolicyResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Request message for upgrading a Data Fusion instance. To change the instance properties, instance update should be used."]
