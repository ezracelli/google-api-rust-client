                        ...
                        pub mod methods {
                            pub mod create {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Optional. Connection id that should be assigned to the created connection."]
                            ...
                            pub mod list {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Required. Maximum number of results per page."]
                            ...
                            pub mod patch {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Required. Update mask for the connection fields to be updated."]
...
pub mod schemas {
    ...
    #[doc = "Credential info for the Cloud SQL."]
    pub struct CloudSqlCredential {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "password")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The password for the credential."]
        pub password: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "username")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The username for the credential."]
        pub username: ::std::option::Option<::std::string::String>,
    }
    impl CloudSqlCredential {
        pub fn builder() -> CloudSqlCredentialBuilder {
            CloudSqlCredentialBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Connection properties specific to the Cloud SQL."]
    pub struct CloudSqlProperties {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "credential")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Input only. Cloud SQL credential."]
        pub credential: ::std::option::Option<::std::boxed::Box<CloudSqlCredential>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub _type: ::std::option::Option<CloudSqlPropertiesTypeEnum>,
    }
    impl CloudSqlProperties {
        pub fn builder() -> CloudSqlPropertiesBuilder {
            CloudSqlPropertiesBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Type of the Cloud SQL database."]
    pub enum CloudSqlPropertiesTypeEnum {
    ...
    impl ::std::default::Default for CloudSqlPropertiesTypeEnum {
        fn default() -> Self {
    ...
    #[doc = "Configuration parameters to establish connection with an external data source, except the credential attributes."]
    pub struct Connection {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "cloudSql")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Cloud SQL properties."]
        pub cloud_sql: ::std::option::Option<::std::boxed::Box<CloudSqlProperties>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "creationTime")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The creation timestamp of the connection."]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "User provided display name for the connection."]
        pub friendly_name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "hasCredential")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. True, if credential is configured for this connection."]
        pub has_credential: ::std::option::Option<::std::primitive::bool>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "lastModifiedTime")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The last update timestamp of the connection."]
        pub last_modified_time: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The resource name of the connection in the form of: `projects/{project_id}/locations/{location_id}/connections/{connection_id}`"]
    ...
    #[doc = "Credential to use with a connection."]
    pub struct ConnectionCredential {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "cloudSql")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Credential for Cloud SQL database."]
        pub cloud_sql: ::std::option::Option<::std::boxed::Box<CloudSqlCredential>>,
    }
    impl ConnectionCredential {
        pub fn builder() -> ConnectionCredentialBuilder {
            ConnectionCredentialBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "The response for ConnectionService.ListConnections."]
    pub struct ListConnectionsResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "connections")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "List of connections."]
