                        ...
                        pub mod methods {
                            ...
                            pub mod list {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Optional. Only include resources that match the filter in the response."]
                                    pub filter: ::std::option::Option<::std::string::String>,
                                    #[builder(
                                        default = "{ ::std::default::Default::default() }",
                                        setter(into)
                                    ...
                                    #[doc = "Optional. Specify how the results should be sorted."]
                                    ...
                                    #[doc = "Optional. Limit on the number of CertificateAuthorities to include in the response. Further CertificateAuthorities can subsequently be obtained by including the ListCertificateAuthoritiesResponse.next_page_token in a subsequent request. If unspecified, the server will pick an appropriate default."]
                                    pub page_size: ::std::option::Option<::std::primitive::i64>,
                                    #[builder(
                                        default = "{ ::std::default::Default::default() }",
                                        setter(into)
                                    ...
                                    #[doc = "Optional. Pagination token, returned earlier via ListCertificateAuthoritiesResponse.next_page_token."]
                                    pub page_token: ::std::option::Option<::std::string::String>,
                                }
                                impl QueryParameters {
                                    pub fn builder() -> QueryParametersBuilder {
                            ...
                            pub mod patch {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Required. A list of fields to be updated in this request."]
                                ...
                                pub mod methods {
                                    ...
                                    pub mod list {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "Optional. Limit on the number of CertificateRevocationLists to include in the response. Further CertificateRevocationLists can subsequently be obtained by including the ListCertificateRevocationListsResponse.next_page_token in a subsequent request. If unspecified, the server will pick an appropriate default."]
                                            pub page_size:
                                                ::std::option::Option<::std::primitive::i64>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                            ...
                                            #[doc = "Optional. Pagination token, returned earlier via ListCertificateRevocationListsResponse.next_page_token."]
                                            pub page_token:
                                                ::std::option::Option<::std::string::String>,
                                        }
                                        impl QueryParameters {
                                ...
                                pub mod methods {
                                    pub mod create {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "Optional. It must be unique within a location and match the regular expression `[a-zA-Z0-9_-]{1,63}`. This field is required when using a CertificateAuthority in the Enterprise CertificateAuthority.Tier, but is optional and its value is ignored otherwise."]
                                            pub certificate_id:
                                                ::std::option::Option<::std::string::String>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                    ...
                                    pub mod list {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "Optional. Only include resources that match the filter in the response. For details on supported filters and syntax, see [Certificates Filtering documentation](https://cloud.google.com/certificate-authority-service/docs/sorting-filtering-certificates#filtering_support)."]
                                            pub filter:
                                                ::std::option::Option<::std::string::String>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                            ...
                                            #[doc = "Optional. Specify how the results should be sorted. For details on supported fields and syntax, see [Certificates Sorting documentation](https://cloud.google.com/certificate-authority-service/docs/sorting-filtering-certificates#sorting_support)."]
                                            pub order_by:
                                                ::std::option::Option<::std::string::String>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                            ...
                                            #[doc = "Optional. Limit on the number of Certificates to include in the response. Further Certificates can subsequently be obtained by including the ListCertificatesResponse.next_page_token in a subsequent request. If unspecified, the server will pick an appropriate default."]
                                            pub page_size:
                                                ::std::option::Option<::std::primitive::i64>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                            ...
                                            #[doc = "Optional. Pagination token, returned earlier via ListCertificatesResponse.next_page_token."]
                                            pub page_token:
                                                ::std::option::Option<::std::string::String>,
                                        }
                                        impl QueryParameters {
                        ...
                        pub mod methods {
                            ...
                            pub mod list {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "Optional. Limit on the number of ReusableConfigs to include in the response. Further ReusableConfigs can subsequently be obtained by including the ListReusableConfigsResponse.next_page_token in a subsequent request. If unspecified, the server will pick an appropriate default."]
                                    pub page_size: ::std::option::Option<::std::primitive::i64>,
                                    #[builder(
                                        default = "{ ::std::default::Default::default() }",
                                        setter(into)
                                    ...
                                    #[doc = "Optional. Pagination token, returned earlier via ListReusableConfigsResponse.next_page_token."]
                                    pub page_token: ::std::option::Option<::std::string::String>,
                                }
                                impl QueryParameters {
                                    pub fn builder() -> QueryParametersBuilder {
...
pub mod schemas {
    ...
    impl AccessUrls {
        pub fn builder() -> AccessUrlsBuilder {
            AccessUrlsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ActivateCertificateAuthorityRequest {
        pub fn builder() -> ActivateCertificateAuthorityRequestBuilder {
            ActivateCertificateAuthorityRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl AllowedConfigList {
        pub fn builder() -> AllowedConfigListBuilder {
            AllowedConfigListBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl AllowedSubjectAltNames {
        pub fn builder() -> AllowedSubjectAltNamesBuilder {
            AllowedSubjectAltNamesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BillingView {
        pub fn builder() -> BillingViewBuilder {
            BillingViewBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl CaOptions {
        pub fn builder() -> CaOptionsBuilder {
            CaOptionsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct Certificate {
        ...
        pub certificate_description:
            ::std::option::Option<::std::boxed::Box<CertificateDescription>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "config")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub struct CertificateAuthority {
        ...
        pub certificate_policy:
            ::std::option::Option<::std::boxed::Box<CertificateAuthorityPolicy>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "config")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl CertificateAuthority {
        pub fn builder() -> CertificateAuthorityBuilder {
            CertificateAuthorityBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Output only. The State for this CertificateAuthority."]
    ...
    impl ::std::default::Default for CertificateAuthorityStateEnum {
        fn default() -> Self {
    ...
    impl ::std::default::Default for CertificateAuthorityTierEnum {
        fn default() -> Self {
    ...
    impl ::std::default::Default for CertificateAuthorityTypeEnum {
        fn default() -> Self {
    ...
    pub struct CertificateAuthorityPolicy {
        ...
        pub overwrite_config_values:
            ::std::option::Option<::std::boxed::Box<ReusableConfigWrapper>>,
    }
    impl CertificateAuthorityPolicy {
        pub fn builder() -> CertificateAuthorityPolicyBuilder {
            CertificateAuthorityPolicyBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl CertificateConfig {
        pub fn builder() -> CertificateConfigBuilder {
            CertificateConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct CertificateDescription {
        ...
        pub aia_issuing_certificate_urls:
    ...
    impl CertificateDescription {
        pub fn builder() -> CertificateDescriptionBuilder {
            CertificateDescriptionBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl CertificateFingerprint {
        pub fn builder() -> CertificateFingerprintBuilder {
            CertificateFingerprintBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl CertificateRevocationList {
        pub fn builder() -> CertificateRevocationListBuilder {
            CertificateRevocationListBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Output only. The State for this CertificateRevocationList."]
    ...
    impl ::std::default::Default for CertificateRevocationListStateEnum {
        fn default() -> Self {
            Self::StateUnspecified
        }
    }
    ...
    impl DisableCertificateAuthorityRequest {
        pub fn builder() -> DisableCertificateAuthorityRequestBuilder {
            DisableCertificateAuthorityRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl EnableCertificateAuthorityRequest {
        pub fn builder() -> EnableCertificateAuthorityRequestBuilder {
            EnableCertificateAuthorityRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ExtendedKeyUsageOptions {
        pub fn builder() -> ExtendedKeyUsageOptionsBuilder {
            ExtendedKeyUsageOptionsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl FetchCertificateAuthorityCsrResponse {
        pub fn builder() -> FetchCertificateAuthorityCsrResponseBuilder {
            FetchCertificateAuthorityCsrResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1AttributeValue {
        pub fn builder() -> GoogleApiServicecontrolV1AttributeValueBuilder {
            GoogleApiServicecontrolV1AttributeValueBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1Attributes {
        pub fn builder() -> GoogleApiServicecontrolV1AttributesBuilder {
            GoogleApiServicecontrolV1AttributesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1Distribution {
        pub fn builder() -> GoogleApiServicecontrolV1DistributionBuilder {
            GoogleApiServicecontrolV1DistributionBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1ExplicitBuckets {
        pub fn builder() -> GoogleApiServicecontrolV1ExplicitBucketsBuilder {
            GoogleApiServicecontrolV1ExplicitBucketsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1ExponentialBuckets {
        pub fn builder() -> GoogleApiServicecontrolV1ExponentialBucketsBuilder {
            GoogleApiServicecontrolV1ExponentialBucketsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1HttpRequest {
        pub fn builder() -> GoogleApiServicecontrolV1HttpRequestBuilder {
            GoogleApiServicecontrolV1HttpRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1LinearBuckets {
        pub fn builder() -> GoogleApiServicecontrolV1LinearBucketsBuilder {
            GoogleApiServicecontrolV1LinearBucketsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleApiServicecontrolV1LogEntry {
        ...
        pub source_location: ::std::option::Option<
            ::std::boxed::Box<GoogleApiServicecontrolV1LogEntrySourceLocation>,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl GoogleApiServicecontrolV1LogEntry {
        pub fn builder() -> GoogleApiServicecontrolV1LogEntryBuilder {
            GoogleApiServicecontrolV1LogEntryBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "The severity of the log entry. The default value is `LogSeverity.DEFAULT`."]
    ...
    impl ::std::default::Default for GoogleApiServicecontrolV1LogEntrySeverityEnum {
        fn default() -> Self {
            Self::Default
        }
    }
    ...
    impl GoogleApiServicecontrolV1LogEntryOperation {
        pub fn builder() -> GoogleApiServicecontrolV1LogEntryOperationBuilder {
            GoogleApiServicecontrolV1LogEntryOperationBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1LogEntrySourceLocation {
        pub fn builder() -> GoogleApiServicecontrolV1LogEntrySourceLocationBuilder {
            GoogleApiServicecontrolV1LogEntrySourceLocationBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1MetricValue {
        pub fn builder() -> GoogleApiServicecontrolV1MetricValueBuilder {
            GoogleApiServicecontrolV1MetricValueBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1MetricValueSet {
        pub fn builder() -> GoogleApiServicecontrolV1MetricValueSetBuilder {
            GoogleApiServicecontrolV1MetricValueSetBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1Operation {
        pub fn builder() -> GoogleApiServicecontrolV1OperationBuilder {
            GoogleApiServicecontrolV1OperationBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "DO NOT USE. This is an experimental field."]
    ...
    impl ::std::default::Default for GoogleApiServicecontrolV1OperationImportanceEnum {
        fn default() -> Self {
            Self::Low
        }
    }
    ...
    pub struct GoogleApiServicecontrolV1QuotaProperties {
        ...
        pub quota_mode:
            ::std::option::Option<GoogleApiServicecontrolV1QuotaPropertiesQuotaModeEnum>,
    }
    impl GoogleApiServicecontrolV1QuotaProperties {
        pub fn builder() -> GoogleApiServicecontrolV1QuotaPropertiesBuilder {
            GoogleApiServicecontrolV1QuotaPropertiesBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Quota mode for this operation."]
    ...
    impl ::std::default::Default for GoogleApiServicecontrolV1QuotaPropertiesQuotaModeEnum {
        fn default() -> Self {
            Self::Acquire
        }
    }
    ...
    impl GoogleApiServicecontrolV1ReportRequest {
        pub fn builder() -> GoogleApiServicecontrolV1ReportRequestBuilder {
            GoogleApiServicecontrolV1ReportRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiServicecontrolV1ResourceInfo {
        pub fn builder() -> GoogleApiServicecontrolV1ResourceInfoBuilder {
            GoogleApiServicecontrolV1ResourceInfoBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleApiServicecontrolV1TraceSpan {
        ...
        pub attributes:
            ::std::option::Option<::std::boxed::Box<GoogleApiServicecontrolV1Attributes>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl GoogleApiServicecontrolV1TraceSpan {
        pub fn builder() -> GoogleApiServicecontrolV1TraceSpanBuilder {
            GoogleApiServicecontrolV1TraceSpanBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Distinguishes between spans generated in a particular context. For example, two spans with the same name may be distinguished using `CLIENT` (caller) and `SERVER` (callee) to identify an RPC call."]
    ...
    impl ::std::default::Default for GoogleApiServicecontrolV1TraceSpanSpanKindEnum {
        fn default() -> Self {
    ...
    impl GoogleApiServicecontrolV1TruncatableString {
        pub fn builder() -> GoogleApiServicecontrolV1TruncatableStringBuilder {
            GoogleApiServicecontrolV1TruncatableStringBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl IssuanceModes {
        pub fn builder() -> IssuanceModesBuilder {
            IssuanceModesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl IssuingOptions {
        pub fn builder() -> IssuingOptionsBuilder {
            IssuingOptionsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl KeyId {
        pub fn builder() -> KeyIdBuilder {
            KeyIdBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl KeyUsageOptions {
        pub fn builder() -> KeyUsageOptionsBuilder {
            KeyUsageOptionsBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl KeyVersionSpec {
        pub fn builder() -> KeyVersionSpecBuilder {
            KeyVersionSpecBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Required. The algorithm to use for creating a managed Cloud KMS key for a for a simplified experience. All managed keys will be have their ProtectionLevel as `HSM`."]
    ...
    impl ::std::default::Default for KeyVersionSpecAlgorithmEnum {
        fn default() -> Self {
            Self::SignHashAlgorithmUnspecified
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListCertificateAuthoritiesResponse {
        pub fn builder() -> ListCertificateAuthoritiesResponseBuilder {
            ListCertificateAuthoritiesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListCertificateRevocationListsResponse {
        pub fn builder() -> ListCertificateRevocationListsResponseBuilder {
            ListCertificateRevocationListsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListCertificatesResponse {
        pub fn builder() -> ListCertificatesResponseBuilder {
            ListCertificatesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct ListReusableConfigsResponse {
        ...
        pub reusable_configs:
            ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ReusableConfig>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "unreachable")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "A list of locations (e.g. \"us-west1\") that could not be reached."]
    ...
    impl ListReusableConfigsResponse {
        pub fn builder() -> ListReusableConfigsResponseBuilder {
            ListReusableConfigsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ObjectId {
        pub fn builder() -> ObjectIdBuilder {
            ObjectIdBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ::std::default::Default for PublicKeyTypeEnum {
        fn default() -> Self {
    ...
    impl RestoreCertificateAuthorityRequest {
        pub fn builder() -> RestoreCertificateAuthorityRequestBuilder {
            RestoreCertificateAuthorityRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ReusableConfig {
        pub fn builder() -> ReusableConfigBuilder {
            ReusableConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ReusableConfigValues {
        pub fn builder() -> ReusableConfigValuesBuilder {
            ReusableConfigValuesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ReusableConfigWrapper {
        pub fn builder() -> ReusableConfigWrapperBuilder {
            ReusableConfigWrapperBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl RevocationDetails {
        pub fn builder() -> RevocationDetailsBuilder {
    ...
    impl ::std::default::Default for RevocationDetailsRevocationStateEnum {
        fn default() -> Self {
    ...
    impl RevokeCertificateRequest {
        pub fn builder() -> RevokeCertificateRequestBuilder {
            RevokeCertificateRequestBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Required. The RevocationReason for revoking this certificate."]
    ...
    impl ::std::default::Default for RevokeCertificateRequestReasonEnum {
        fn default() -> Self {
            Self::RevocationReasonUnspecified
        }
    }
    ...
    impl RevokedCertificate {
        pub fn builder() -> RevokedCertificateBuilder {
            RevokedCertificateBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "The reason the Certificate was revoked."]
    ...
    impl ::std::default::Default for RevokedCertificateRevocationReasonEnum {
        fn default() -> Self {
            Self::RevocationReasonUnspecified
        }
    }
    ...
    impl ScheduleDeleteCertificateAuthorityRequest {
        pub fn builder() -> ScheduleDeleteCertificateAuthorityRequestBuilder {
            ScheduleDeleteCertificateAuthorityRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl SubjectAltNames {
        pub fn builder() -> SubjectAltNamesBuilder {
            SubjectAltNamesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl SubjectConfig {
        pub fn builder() -> SubjectConfigBuilder {
            SubjectConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl SubjectDescription {
        pub fn builder() -> SubjectDescriptionBuilder {
            SubjectDescriptionBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl SubordinateConfig {
        pub fn builder() -> SubordinateConfigBuilder {
            SubordinateConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl SubordinateConfigChain {
        pub fn builder() -> SubordinateConfigChainBuilder {
            SubordinateConfigChainBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl X509Extension {
        pub fn builder() -> X509ExtensionBuilder {
            X509ExtensionBuilder::default()
        }
    }
}
