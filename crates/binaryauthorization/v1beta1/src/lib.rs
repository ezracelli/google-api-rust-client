...
pub struct AdmissionWhitelistPattern {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "An image name pattern to allowlist, in the form `registry/path/to/image`. This supports a trailing `*` as a wildcard, but this is allowed only in text after the `registry/` part. Also wildcards do not match `/`, i.e., gcr.io/nginx* matches gcr.io/nginx@latest, but it does not match gcr.io/nginx/image."]
...
pub struct Attestor {
    ...
    pub user_owned_drydock_note: ::std::option::Option<::std::boxed::Box<UserOwnedDrydockNote>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct Policy {
    ...
    pub global_policy_evaluation_mode: ::std::option::Option<PolicyGlobalPolicyEvaluationModeEnum>,
...
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "An user owned drydock note references a Drydock ATTESTATION_AUTHORITY Note created by the user."]
pub struct UserOwnedDrydockNote {
    ...
    pub public_keys: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<AttestorPublicKey>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
