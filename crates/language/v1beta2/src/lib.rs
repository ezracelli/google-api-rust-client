...
pub mod schemas {
    ...
    #[doc = "Represents dependency parse tree information for a token."]
    ...
    pub struct Document {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "boilerplateHandling")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Indicates how detected boilerplate(e.g. advertisements, copyright declarations, banners) should be handled for this document. If not specified, boilerplate will be treated the same as content."]
        pub boilerplate_handling: ::std::option::Option<DocumentBoilerplateHandlingEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub language: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "referenceWebUri")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The web URI where the document comes from. This URI is not used for fetching the content, but as a hint for analyzing the document."]
        pub reference_web_uri: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "type")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Indicates how detected boilerplate(e.g. advertisements, copyright declarations, banners) should be handled for this document. If not specified, boilerplate will be treated the same as content."]
    pub enum DocumentBoilerplateHandlingEnum {
        #[serde(rename = "BOILERPLATE_HANDLING_UNSPECIFIED")]
        #[doc = "The boilerplate handling is not specified."]
        BoilerplateHandlingUnspecified,
        #[serde(rename = "SKIP_BOILERPLATE")]
        #[doc = "Do not analyze detected boilerplate. Reference web URI is required for detecting boilerplate."]
        SkipBoilerplate,
        #[serde(rename = "KEEP_BOILERPLATE")]
        #[doc = "Treat boilerplate the same as content."]
        KeepBoilerplate,
    }
    impl ::std::default::Default for DocumentBoilerplateHandlingEnum {
        fn default() -> Self {
            Self::BoilerplateHandlingUnspecified
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Required. If the type is not set or is `TYPE_UNSPECIFIED`, returns an `INVALID_ARGUMENT` error."]
    ...
    #[doc = "All available features for sentiment, syntax, and semantic analysis. Setting each one to true will enable that specific analysis for the input. Next ID: 10"]
    pub struct Features {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "classifyText")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Classify the full document into categories. If this is true, the API will use the default model which classifies into a [predefined taxonomy](https://cloud.google.com/natural-language/docs/categories)."]
    ...
    #[doc = "Represents part of speech information for a token."]
    ...
    #[doc = "Represents the feeling associated with the entire text or entities in the text. Next ID: 6"]
