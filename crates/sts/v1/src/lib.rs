...
pub mod schemas {
    ...
    pub struct GoogleIdentityStsV1ExchangeTokenRequest {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Required. An identifier for the type of requested security token. Must be `urn:ietf:params:oauth:token-type:access_token`."]
    ...
    impl GoogleIdentityStsV1ExchangeTokenRequest {
        pub fn builder() -> GoogleIdentityStsV1ExchangeTokenRequestBuilder {
            GoogleIdentityStsV1ExchangeTokenRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleIdentityStsV1ExchangeTokenResponse {
        pub fn builder() -> GoogleIdentityStsV1ExchangeTokenResponseBuilder {
            GoogleIdentityStsV1ExchangeTokenResponseBuilder::default()
        }
    }
}
