...
pub mod schemas {
    ...
    impl GoogleIdentityStsV1betaExchangeTokenRequest {
        pub fn builder() -> GoogleIdentityStsV1betaExchangeTokenRequestBuilder {
            GoogleIdentityStsV1betaExchangeTokenRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleIdentityStsV1betaExchangeTokenResponse {
        pub fn builder() -> GoogleIdentityStsV1betaExchangeTokenResponseBuilder {
            GoogleIdentityStsV1betaExchangeTokenResponseBuilder::default()
        }
    }
}
