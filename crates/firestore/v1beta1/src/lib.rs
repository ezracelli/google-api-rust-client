...
pub struct GoogleFirestoreAdminV1beta1ExportDocumentsMetadata {
    ...
    pub operation_state:
        ::std::option::Option<GoogleFirestoreAdminV1beta1ExportDocumentsMetadataOperationStateEnum>,
...
pub struct GoogleFirestoreAdminV1beta1ImportDocumentsMetadata {
    ...
    pub operation_state:
        ::std::option::Option<GoogleFirestoreAdminV1beta1ImportDocumentsMetadataOperationStateEnum>,
    #[serde(rename = "progressBytes")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "An estimate of the number of bytes processed."]
    pub progress_bytes:
...
pub struct GoogleFirestoreAdminV1beta1IndexOperationMetadata {
    ...
    pub operation_type:
        ::std::option::Option<GoogleFirestoreAdminV1beta1IndexOperationMetadataOperationTypeEnum>,
    #[serde(rename = "startTime")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The time that work began on the operation."]
    pub start_time: ::std::option::Option<::std::string::String>,
...
pub struct GoogleFirestoreAdminV1beta1ListIndexesResponse {
    ...
    #[doc = "The indexes."]
    pub indexes:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleFirestoreAdminV1beta1Index>>>,
