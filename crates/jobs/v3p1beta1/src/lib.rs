...
pub mod schemas {
    ...
    #[doc = "Input only. Custom ranking information for SearchJobsRequest."]
    ...
    #[doc = "Input Only. The histogram request."]
    ...
    #[doc = "Output only. Histogram result that matches HistogramSpec specified in searches."]
