...
pub struct HistogramFacets {
    ...
    pub custom_attribute_histogram_facets:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CustomAttributeHistogramRequest>>>,
...
pub struct HistogramResult {
    ...
    pub values: ::std::option::Option<::std::collections::BTreeMap<String, ::std::primitive::i64>>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "The Histogram search filters."]
...
pub struct HistogramResults {
    ...
    pub custom_attribute_histogram_results:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CustomAttributeHistogramResult>>>,
