...
pub struct JobQuery {
    ...
    pub location_filters: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<LocationFilter>>>,
...
pub struct NamespacedDebugInput {
    ...
    pub absolutely_forced_exp_names: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    ...
    pub absolutely_forced_exp_tags: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    ...
    pub conditionally_forced_exps: ::std::option::Option<::std::vec::Vec<::std::primitive::i64>>,
