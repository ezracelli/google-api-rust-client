...
pub mod schemas {
    ...
    #[doc = "Describes an AdMob ad unit."]
    pub struct AdUnit {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub ad_format: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub ad_types: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub ad_unit_id: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "appId")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[doc = "Describes an AdMob app for a specific platform (For example: Android or iOS)."]
    pub struct App {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "appId")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        pub linked_app_info: ::std::option::Option<::std::boxed::Box<AppLinkedAppInfo>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub manual_app_info: ::std::option::Option<::std::boxed::Box<AppManualAppInfo>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[doc = "Information from the app store if the app is linked to an app store."]
    ...
    impl AppLinkedAppInfo {
        pub fn builder() -> AppLinkedAppInfoBuilder {
            AppLinkedAppInfoBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Information provided for manual apps which are not linked to an application store (Example: Google Play, App Store)."]
    ...
    impl AppManualAppInfo {
        pub fn builder() -> AppManualAppInfoBuilder {
            AppManualAppInfoBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response for the ad units list request."]
    pub struct ListAdUnitsResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "adUnits")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The resulting ad units for the requested account."]
        pub ad_units: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<AdUnit>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl ListAdUnitsResponse {
        pub fn builder() -> ListAdUnitsResponseBuilder {
            ListAdUnitsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response for the apps list request."]
    pub struct ListAppsResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "apps")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The resulting apps for the requested account."]
        pub apps: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<App>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "nextPageToken")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl ListAppsResponse {
        pub fn builder() -> ListAppsResponseBuilder {
            ListAppsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
