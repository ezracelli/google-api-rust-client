...
pub mod resources {
    ...
    pub mod projects {
        pub mod resources {
            pub mod locations {
                pub mod methods {
                    pub mod search_all_assignments {
                        #[derive(
                            Clone,
                            Debug,
                            PartialEq,
...
pub mod schemas {
    ...
    pub struct CapacityCommitment {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The plan this capacity commitment is converted to after commitment_end_time passes. Once the plan is changed, committed period is extended according to commitment plan. Only applicable for ANNUAL and TRIAL commitments."]
    ...
    #[doc = "The response for ReservationService.SearchAllAssignments."]
    ...
    impl SearchAllAssignmentsResponse {
        pub fn builder() -> SearchAllAssignmentsResponseBuilder {
            SearchAllAssignmentsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
