        ...
        pub mod methods {
            pub mod list {
                ...
                pub struct QueryParameters {
                    ...
                    #[serde(rename = "filter")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "Only list services that conform to the given filter. The allowed filter strings are `state:ENABLED` and `state:DISABLED`."]
                    pub filter: ::std::option::Option<::std::string::String>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "pageSize")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "Requested size of the next page of data. Requested page size cannot exceed 200. If not set, the default page size is 50."]
                    pub page_size: ::std::option::Option<::std::primitive::i64>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "pageToken")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                ...
                pub mod methods {
                    pub mod get {
                        ...
                        pub enum QueryParametersViewEnum {
                            #[serde(rename = "QUOTA_VIEW_UNSPECIFIED")]
                            #[doc = "No quota view specified. Requests that do not specify a quota view will typically default to the BASIC view."]
                            QuotaViewUnspecified,
                            #[serde(rename = "BASIC")]
                            #[doc = "Only buckets with overrides are shown in the response."]
                            Basic,
                            #[serde(rename = "FULL")]
                            #[doc = "Include per-location buckets even if they do not have overrides. When the view is FULL, and a limit has regional or zonal quota, the limit will include buckets for all regions or zones that could support overrides, even if none are currently present. In some cases this will cause the response to become very large; callers that do not need this extra information should use the BASIC view instead."]
                            Full,
                        }
                        impl ::std::default::Default for QueryParametersViewEnum {
                            fn default() -> Self {
                                Self::QuotaViewUnspecified
                            }
                        }
                    }
                    pub mod list {
                                ...
                                pub mod methods {
                                    pub mod create {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[serde(rename = "forceOnly")]
                                            #[serde(
                                                skip_serializing_if = "::std::option::Option::is_none"
                                            )]
                                            #[doc = "The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set."]
                                            pub force_only:
                                                ::std::option::Option<QueryParametersForceOnlyEnum>,
                                        }
                                        impl QueryParameters {
                                            pub fn builder() -> QueryParametersBuilder {
                                                QueryParametersBuilder::default()
                                        ...
                                        #[doc = "The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set."]
                                        pub enum QueryParametersForceOnlyEnum {
                                            #[serde(rename = "QUOTA_SAFETY_CHECK_UNSPECIFIED")]
                                            #[doc = "Unspecified quota safety check."]
                                            QuotaSafetyCheckUnspecified,
                                            #[serde(rename = "LIMIT_DECREASE_BELOW_USAGE")]
                                            #[doc = "Validates that a quota mutation would not cause the consumer's effective limit to be lower than the consumer's quota usage."]
                                            LimitDecreaseBelowUsage,
                                            #[serde(rename = "LIMIT_DECREASE_PERCENTAGE_TOO_HIGH")]
                                            #[doc = "Validates that a quota mutation would not cause the consumer's effective limit to decrease by more than 10 percent."]
                                            LimitDecreasePercentageTooHigh,
                                        }
                                        impl ::std::default::Default for QueryParametersForceOnlyEnum {
                                            fn default() -> Self {
                                                Self::QuotaSafetyCheckUnspecified
                                            }
                                        }
                                    }
                                    pub mod delete {
                                    ...
                                    pub mod patch {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "Update only the specified fields of the override. If unset, all fields will be updated."]
                                            pub update_mask:
                                                ::std::option::Option<::std::string::String>,
                                        }
                                        impl QueryParameters {
...
pub mod schemas {
    ...
    #[doc = "Quota policy created by quota administrator."]
    pub struct AdminQuotaPolicy {
        ...
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The resource name of the policy. This name is generated by the server when the policy is created. Example names would be: `organizations/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/adminQuotaPolicies/4a3f2c1d`"]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl AdminQuotaPolicy {
        pub fn builder() -> AdminQuotaPolicyBuilder {
            AdminQuotaPolicyBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message for BatchCreateAdminOverrides"]
    pub struct BatchCreateAdminOverridesResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "overrides")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The overrides that were created."]
        pub overrides: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<QuotaOverride>>>,
    }
    impl BatchCreateAdminOverridesResponse {
        pub fn builder() -> BatchCreateAdminOverridesResponseBuilder {
            BatchCreateAdminOverridesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for BatchCreateConsumerOverrides"]
    ...
    impl BatchCreateConsumerOverridesResponse {
        pub fn builder() -> BatchCreateConsumerOverridesResponseBuilder {
            BatchCreateConsumerOverridesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Request message for the `BatchEnableServices` method."]
    pub struct BatchEnableServicesRequest {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "serviceIds")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The identifiers of the services to enable on the project. A valid identifier would be: serviceusage.googleapis.com Enabling services requires that each service is public or is shared with the user enabling the service. Two or more services must be specified. To enable a single service, use the `EnableService` method instead. A single request can enable a maximum of 20 services at a time. If more than 20 services are specified, the request will fail, and no state changes will occur."]
        pub service_ids: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    }
    impl BatchEnableServicesRequest {
        pub fn builder() -> BatchEnableServicesRequestBuilder {
            BatchEnableServicesRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for the `BatchEnableServices` method. This response message is assigned to the `response` field of the returned Operation when that operation is done."]
    pub struct BatchEnableServicesResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "failures")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "If allow_partial_success is true, and one or more services could not be enabled, this field contains the details about each failure."]
        pub failures: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<EnableFailure>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "services")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The new state of the services after enabling."]
        pub services: ::std::option::Option<
            ::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV1Service>>,
        >,
    }
    impl BatchEnableServicesResponse {
        pub fn builder() -> BatchEnableServicesResponseBuilder {
            BatchEnableServicesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Consumer quota settings for a quota limit."]
    pub struct ConsumerQuotaLimit {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "allowsAdminOverrides")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Whether admin overrides are allowed on this limit"]
        pub allows_admin_overrides: ::std::option::Option<::std::primitive::bool>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "isPrecise")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Whether this limit is precise or imprecise."]
        pub is_precise: ::std::option::Option<::std::primitive::bool>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "metric")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The name of the parent metric of this limit. An example name would be: `compute.googleapis.com/cpus`"]
        pub metric: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The resource name of the quota limit. An example name would be: `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion` The resource name is intended to be opaque and should not be parsed for its component strings, since its representation could change in the future."]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "quotaBuckets")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Summary of the enforced quota buckets, organized by quota dimension, ordered from least specific to most specific (for example, the global default bucket, with no quota dimensions, will always appear first)."]
        pub quota_buckets: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<QuotaBucket>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "unit")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl ConsumerQuotaLimit {
        pub fn builder() -> ConsumerQuotaLimitBuilder {
            ConsumerQuotaLimitBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Consumer quota settings for a quota metric."]
    pub struct ConsumerQuotaMetric {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "consumerQuotaLimits")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The consumer quota for each quota limit defined on the metric."]
        pub consumer_quota_limits:
            ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ConsumerQuotaLimit>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "descendantConsumerQuotaLimits")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The quota limits targeting the descendant containers of the consumer in request. If the consumer in request is of type `organizations` or `folders`, the field will list per-project limits in the metric; if the consumer in request is of type `project`, the field will be empty. The `quota_buckets` field of each descendant consumer quota limit will not be populated."]
        ...
        #[serde(rename = "metric")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The name of the metric. An example name would be: `compute.googleapis.com/cpus`"]
        pub metric: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        #[serde(rename = "unit")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The units in which the metric value is reported."]
        pub unit: ::std::option::Option<::std::string::String>,
    }
    impl ConsumerQuotaMetric {
        pub fn builder() -> ConsumerQuotaMetricBuilder {
            ConsumerQuotaMetricBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Request message for the `DisableService` method."]
    pub struct DisableServiceRequest {}
    impl DisableServiceRequest {
        pub fn builder() -> DisableServiceRequestBuilder {
            DisableServiceRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for the `DisableService` method. This response message is assigned to the `response` field of the returned Operation when that operation is done."]
    pub struct DisableServiceResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "service")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The new state of the service after disabling."]
        pub service: ::std::option::Option<::std::boxed::Box<GoogleApiServiceusageV1Service>>,
    }
    impl DisableServiceResponse {
        pub fn builder() -> DisableServiceResponseBuilder {
            DisableServiceResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Provides error messages for the failing services."]
    ...
    impl EnableFailure {
        pub fn builder() -> EnableFailureBuilder {
            EnableFailureBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Request message for the `EnableService` method."]
    pub struct EnableServiceRequest {}
    impl EnableServiceRequest {
        pub fn builder() -> EnableServiceRequestBuilder {
            EnableServiceRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for the `EnableService` method. This response message is assigned to the `response` field of the returned Operation when that operation is done."]
    ...
    impl EnableServiceResponse {
        pub fn builder() -> EnableServiceResponseBuilder {
            EnableServiceResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message for getting service identity."]
    pub struct GetServiceIdentityResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "identity")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Service identity that service producer can use to access consumer resources. If exists is true, it contains email and unique_id. If exists is false, it contains pre-constructed email and empty unique_id."]
        pub identity: ::std::option::Option<::std::boxed::Box<ServiceIdentity>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "state")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Service identity state."]
        pub state: ::std::option::Option<GetServiceIdentityResponseStateEnum>,
    }
    impl GetServiceIdentityResponse {
        pub fn builder() -> GetServiceIdentityResponseBuilder {
            GetServiceIdentityResponseBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Service identity state."]
    pub enum GetServiceIdentityResponseStateEnum {
        #[serde(rename = "IDENTITY_STATE_UNSPECIFIED")]
        #[doc = "Default service identity state. This value is used if the state is omitted."]
        IdentityStateUnspecified,
        #[serde(rename = "ACTIVE")]
        #[doc = "Service identity has been created and can be used."]
        Active,
    }
    impl ::std::default::Default for GetServiceIdentityResponseStateEnum {
        fn default() -> Self {
            Self::IdentityStateUnspecified
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleApiService {
        pub fn builder() -> GoogleApiServiceBuilder {
            GoogleApiServiceBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "The operation metadata returned for the batchend services operation."]
    ...
    impl GoogleApiServiceusageV1OperationMetadata {
        pub fn builder() -> GoogleApiServiceusageV1OperationMetadataBuilder {
            GoogleApiServiceusageV1OperationMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "A service that is available for use by the consumer."]
    pub struct GoogleApiServiceusageV1Service {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "config")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The service configuration of the available service. Some fields may be filtered out of the configuration in responses to the `ListServices` method. These fields are present only in responses to the `GetService` method."]
        pub config: ::std::option::Option<::std::boxed::Box<GoogleApiServiceusageV1ServiceConfig>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        pub state: ::std::option::Option<GoogleApiServiceusageV1ServiceStateEnum>,
    }
    impl GoogleApiServiceusageV1Service {
        pub fn builder() -> GoogleApiServiceusageV1ServiceBuilder {
            GoogleApiServiceusageV1ServiceBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Whether or not the service has been enabled for use by the consumer."]
    pub enum GoogleApiServiceusageV1ServiceStateEnum {
        #[serde(rename = "STATE_UNSPECIFIED")]
        #[doc = "The default value, which indicates that the enabled state of the service is unspecified or not meaningful. Currently, all consumers other than projects (such as folders and organizations) are always in this state."]
        StateUnspecified,
        #[serde(rename = "DISABLED")]
        #[doc = "The service cannot be used by this consumer. It has either been explicitly disabled, or has never been enabled."]
        Disabled,
        #[serde(rename = "ENABLED")]
        #[doc = "The service has been explicitly enabled for use by this consumer."]
        Enabled,
    }
    impl ::std::default::Default for GoogleApiServiceusageV1ServiceStateEnum {
        fn default() -> Self {
    ...
    #[doc = "The configuration of the service."]
    pub struct GoogleApiServiceusageV1ServiceConfig {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "apis")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "A list of API interfaces exported by this service. Contains only the names, versions, and method names of the interfaces."]
        pub apis: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Api>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "authentication")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        #[serde(rename = "documentation")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Additional API documentation. Contains only the summary and the documentation URL."]
        pub documentation: ::std::option::Option<::std::boxed::Box<Documentation>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "endpoints")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Configuration for network endpoints. Contains only the names and aliases of the endpoints."]
        pub endpoints: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<Endpoint>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "monitoredResources")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        #[serde(rename = "monitoring")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Monitoring configuration. This should not include the 'producer_destinations' field."]
        pub monitoring: ::std::option::Option<::std::boxed::Box<Monitoring>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The DNS address at which this service is available. An example DNS address would be: `calendar.googleapis.com`."]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "quota")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl GoogleApiServiceusageV1ServiceConfig {
        pub fn builder() -> GoogleApiServiceusageV1ServiceConfigBuilder {
            GoogleApiServiceusageV1ServiceConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleApiServiceusageV1beta1GetServiceIdentityResponse {
        ...
        #[doc = "Service identity that service producer can use to access consumer resources. If exists is true, it contains email and unique_id. If exists is false, it contains pre-constructed email and empty unique_id."]
        pub identity:
            ::std::option::Option<::std::boxed::Box<GoogleApiServiceusageV1beta1ServiceIdentity>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "state")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Service identity state."]
        pub state:
            ::std::option::Option<GoogleApiServiceusageV1beta1GetServiceIdentityResponseStateEnum>,
    }
    impl GoogleApiServiceusageV1beta1GetServiceIdentityResponse {
        pub fn builder() -> GoogleApiServiceusageV1beta1GetServiceIdentityResponseBuilder {
            GoogleApiServiceusageV1beta1GetServiceIdentityResponseBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Service identity state."]
    pub enum GoogleApiServiceusageV1beta1GetServiceIdentityResponseStateEnum {
        #[serde(rename = "IDENTITY_STATE_UNSPECIFIED")]
        #[doc = "Default service identity state. This value is used if the state is omitted."]
        IdentityStateUnspecified,
        #[serde(rename = "ACTIVE")]
    ...
    impl ::std::default::Default for GoogleApiServiceusageV1beta1GetServiceIdentityResponseStateEnum {
        fn default() -> Self {
            Self::IdentityStateUnspecified
        }
    }
    ...
    #[doc = "Service identity for a service. This is the identity that service producer should use to access consumer resources."]
    pub struct GoogleApiServiceusageV1beta1ServiceIdentity {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "email")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The email address of the service account that a service producer would use to access consumer resources."]
        pub email: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "uniqueId")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The unique and stable id of the service account. https://cloud.google.com/iam/reference/rest/v1/projects.serviceAccounts#ServiceAccount"]
        pub unique_id: ::std::option::Option<::std::string::String>,
    }
    impl GoogleApiServiceusageV1beta1ServiceIdentity {
        pub fn builder() -> GoogleApiServiceusageV1beta1ServiceIdentityBuilder {
            GoogleApiServiceusageV1beta1ServiceIdentityBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Request message for ImportAdminOverrides"]
    pub struct ImportAdminOverridesRequest {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "force")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Whether to force the creation of the quota overrides. Setting the force parameter to 'true' ignores all quota safety checks that would fail the request. QuotaSafetyCheck lists all such validations."]
        ...
        #[doc = "The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set."]
        pub force_only:
            ::std::option::Option<::std::vec::Vec<ImportAdminOverridesRequestForceOnlyEnum>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "inlineSource")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The import data is specified in the request message itself"]
        pub inline_source: ::std::option::Option<::std::boxed::Box<OverrideInlineSource>>,
    }
    impl ImportAdminOverridesRequest {
        pub fn builder() -> ImportAdminOverridesRequestBuilder {
            ImportAdminOverridesRequestBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    pub enum ImportAdminOverridesRequestForceOnlyEnum {
        #[serde(rename = "QUOTA_SAFETY_CHECK_UNSPECIFIED")]
        #[doc = "Unspecified quota safety check."]
        QuotaSafetyCheckUnspecified,
        #[serde(rename = "LIMIT_DECREASE_BELOW_USAGE")]
    ...
    impl ::std::default::Default for ImportAdminOverridesRequestForceOnlyEnum {
        fn default() -> Self {
            Self::QuotaSafetyCheckUnspecified
        }
    }
    ...
    #[doc = "Response message for ImportAdminOverrides"]
    ...
    impl ImportAdminOverridesResponse {
        pub fn builder() -> ImportAdminOverridesResponseBuilder {
            ImportAdminOverridesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for ImportAdminQuotaPolicies"]
    pub struct ImportAdminQuotaPoliciesResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "policies")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The policies that were created from the imported data."]
        pub policies: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<AdminQuotaPolicy>>>,
    }
    impl ImportAdminQuotaPoliciesResponse {
        pub fn builder() -> ImportAdminQuotaPoliciesResponseBuilder {
            ImportAdminQuotaPoliciesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Request message for ImportConsumerOverrides"]
    pub struct ImportConsumerOverridesRequest {
        ...
        #[doc = "The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set."]
        pub force_only:
            ::std::option::Option<::std::vec::Vec<ImportConsumerOverridesRequestForceOnlyEnum>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "inlineSource")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The import data is specified in the request message itself"]
    ...
    impl ImportConsumerOverridesRequest {
        pub fn builder() -> ImportConsumerOverridesRequestBuilder {
            ImportConsumerOverridesRequestBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    pub enum ImportConsumerOverridesRequestForceOnlyEnum {
        #[serde(rename = "QUOTA_SAFETY_CHECK_UNSPECIFIED")]
        #[doc = "Unspecified quota safety check."]
        QuotaSafetyCheckUnspecified,
        #[serde(rename = "LIMIT_DECREASE_BELOW_USAGE")]
    ...
    impl ::std::default::Default for ImportConsumerOverridesRequestForceOnlyEnum {
        fn default() -> Self {
            Self::QuotaSafetyCheckUnspecified
        }
    }
    ...
    #[doc = "Response message for ImportConsumerOverrides"]
    ...
    impl ImportConsumerOverridesResponse {
        pub fn builder() -> ImportConsumerOverridesResponseBuilder {
            ImportConsumerOverridesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message for ListAdminOverrides."]
    ...
    impl ListAdminOverridesResponse {
        pub fn builder() -> ListAdminOverridesResponseBuilder {
            ListAdminOverridesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for ListConsumerOverrides."]
    ...
    impl ListConsumerOverridesResponse {
        pub fn builder() -> ListConsumerOverridesResponseBuilder {
            ListConsumerOverridesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    )]
    #[doc = "Response message for ListConsumerQuotaMetrics"]
    pub struct ListConsumerQuotaMetricsResponse {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "metrics")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Quota settings for the consumer, organized by quota metric."]
        pub metrics: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ConsumerQuotaMetric>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "nextPageToken")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Token identifying which result to start with; returned by a previous list call."]
    ...
    impl ListConsumerQuotaMetricsResponse {
        pub fn builder() -> ListConsumerQuotaMetricsResponseBuilder {
            ListConsumerQuotaMetricsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Response message for the `ListServices` method."]
    ...
    #[doc = "Import data embedded in the request message"]
    pub struct OverrideInlineSource {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "overrides")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The overrides to create. Each override must have a value for 'metric' and 'unit', to specify which metric and which limit the override should be applied to. The 'name' field of the override does not need to be set; it is ignored."]
        pub overrides: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<QuotaOverride>>>,
    }
    impl OverrideInlineSource {
        pub fn builder() -> OverrideInlineSourceBuilder {
            OverrideInlineSourceBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "A quota bucket is a quota provisioning unit for a specific set of dimensions."]
    pub struct QuotaBucket {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "adminOverride")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Admin override on this quota bucket."]
        pub admin_override: ::std::option::Option<::std::boxed::Box<QuotaOverride>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "consumerOverride")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Consumer override on this quota bucket."]
        pub consumer_override: ::std::option::Option<::std::boxed::Box<QuotaOverride>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "defaultLimit")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The default limit of this quota bucket, as specified by the service configuration."]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The effective limit of this quota bucket. Equal to default_limit if there are no overrides."]
        pub effective_limit: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "producerOverride")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Producer override on this quota bucket."]
        pub producer_override: ::std::option::Option<::std::boxed::Box<QuotaOverride>>,
    }
    impl QuotaBucket {
        pub fn builder() -> QuotaBucketBuilder {
            QuotaBucketBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct QuotaOverride {
        ...
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The resource name of the override. This name is generated by the server when the override is created. Example names would be: `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/adminOverrides/4a3f2c1d` `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/consumerOverrides/4a3f2c1d` The resource name is intended to be opaque and should not be parsed for its component strings, since its representation could change in the future."]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl QuotaOverride {
        pub fn builder() -> QuotaOverrideBuilder {
            QuotaOverrideBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct Service {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The service configuration of the available service. Some fields may be filtered out of the configuration in responses to the `ListServices` method. These fields are present only in responses to the `GetService` method."]
        pub config: ::std::option::Option<::std::boxed::Box<ServiceConfig>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The resource name of the consumer and service. A valid name would be: - projects/123/services/serviceusage.googleapis.com"]
    ...
    impl ServiceIdentity {
        pub fn builder() -> ServiceIdentityBuilder {
            ServiceIdentityBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
