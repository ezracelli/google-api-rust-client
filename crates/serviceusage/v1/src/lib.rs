        ...
        pub mod methods {
            pub mod batch_get {
                ...
                pub struct QueryParameters {
                    ...
                    #[serde(rename = "names")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "Names of the services to retrieve. An example name would be: `projects/123/services/serviceusage.googleapis.com` where `123` is the project number. A single request can get a maximum of 30 services at a time."]
...
pub mod schemas {
    ...
    #[doc = "Response message for the `BatchGetServices` method."]
    ...
    impl BatchGetServicesResponse {
        pub fn builder() -> BatchGetServicesResponseBuilder {
            BatchGetServicesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct DisableServiceRequest {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "checkIfServiceHasUsage")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Defines the behavior for checking service usage when disabling a service."]
        pub check_if_service_has_usage:
            ::std::option::Option<DisableServiceRequestCheckIfServiceHasUsageEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "disableDependentServices")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Indicates if services that are enabled and which depend on this service should also be disabled. If not set, an error will be generated if any enabled services depend on the service to be disabled. When set, the service, and any enabled services that depend on it, will be disabled together."]
        pub disable_dependent_services: ::std::option::Option<::std::primitive::bool>,
    }
    ...
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Defines the behavior for checking service usage when disabling a service."]
    pub enum DisableServiceRequestCheckIfServiceHasUsageEnum {
        #[serde(rename = "CHECK_IF_SERVICE_HAS_USAGE_UNSPECIFIED")]
        #[doc = "When unset, the default behavior is used, which is SKIP."]
        CheckIfServiceHasUsageUnspecified,
        #[serde(rename = "SKIP")]
        #[doc = "If set, skip checking service usage when disabling a service."]
        Skip,
        #[serde(rename = "CHECK")]
        #[doc = "If set, service usage is checked when disabling the service. If a service, or its dependents, has usage in the last 30 days, the request returns a FAILED_PRECONDITION error."]
        Check,
    }
    impl ::std::default::Default for DisableServiceRequestCheckIfServiceHasUsageEnum {
        fn default() -> Self {
            Self::CheckIfServiceHasUsageUnspecified
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
