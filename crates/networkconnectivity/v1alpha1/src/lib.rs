                                ...
                                pub mod methods {
                                    pub mod create {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "Optional. Unique id for the Hub to create."]
                                            pub hub_id:
                                    ...
                                    pub mod list {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "A filter expression that filters the results listed in the response."]
                                            pub filter:
                                                ::std::option::Option<::std::string::String>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                            ...
                                            #[doc = "Sort the results by a certain order."]
                                            pub order_by:
                                                ::std::option::Option<::std::string::String>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                            ...
                                            #[doc = "The maximum number of results per page that should be returned."]
                                            pub page_size:
                                                ::std::option::Option<::std::primitive::i64>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                        ...
                        pub mod methods {
                            pub mod create {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[serde(rename = "spokeId")]
                                    #[serde(
                                        skip_serializing_if = "::std::option::Option::is_none"
                                    )]
                                    #[doc = "Optional. Unique id for the Spoke to create."]
                                    pub spoke_id: ::std::option::Option<::std::string::String>,
                                }
                                impl QueryParameters {
                                    pub fn builder() -> QueryParametersBuilder {
                                        QueryParametersBuilder::default()
...
pub mod schemas {
    ...
    impl ::std::default::Default for HubStateEnum {
        fn default() -> Self {
    ...
    impl ListHubsResponse {
        pub fn builder() -> ListHubsResponseBuilder {
            ListHubsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListSpokesResponse {
        pub fn builder() -> ListSpokesResponseBuilder {
            ListSpokesResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl RouterApplianceInstance {
        pub fn builder() -> RouterApplianceInstanceBuilder {
            RouterApplianceInstanceBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl Spoke {
        pub fn builder() -> SpokeBuilder {
            SpokeBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Output only. The current lifecycle state of this Hub."]
    ...
    impl ::std::default::Default for SpokeStateEnum {
        fn default() -> Self {
            Self::StateUnspecified
        }
    }
