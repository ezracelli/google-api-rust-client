                                ...
                                pub mod methods {
                                    ...
                                    pub mod list {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "Optional. Filter specifying constraints of a list operation. For example, `Domain.fqdn=\"mydomain.myorginization\"`."]
                                            pub filter:
                                                ::std::option::Option<::std::string::String>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                            ...
                                            #[doc = "If not specified, a default value of 1000 will be used by the service. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response's next_page_token to determine if there are more instances left to be queried."]
                                            pub page_size:
                                                ::std::option::Option<::std::primitive::i64>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                    ...
                                    pub mod patch {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "Mask of fields to update. At least one path must be supplied in this field. The elements of the repeated paths field may only include these fields from Domain: * `labels` * `locations` * `authorized_networks` * `audit_logs_enabled`"]
                                            pub update_mask:
                                                ::std::option::Option<::std::string::String>,
                                        }
                                        impl QueryParameters {
                                        ...
                                        pub mod methods {
                                            pub mod list {
                                                ...
                                                pub struct QueryParameters {
                                                    ...
                                                    #[doc = "Optional. Filter specifying constraints of a list operation. For example, `SqlIntegration.name=\"sql\"`."]
                                                    ...
                                                    #[doc = "Optional. The maximum number of items to return. If not specified, a default value of 1000 will be used by the service. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response'ANIZATIONs next_page_token to determine if there are more instances left to be queried."]
...
pub mod schemas {
    ...
    pub struct DetachTrustRequest {
        ...
        #[serde(rename = "trust")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The domain trust resource to removed."]
        pub trust: ::std::option::Option<::std::boxed::Box<Trust>>,
    }
    ...
    #[doc = "If the domain is being changed, it will be placed into the UPDATING state, which indicates that the resource is being reconciled. At this point, Get will reflect an intermediate state."]
    pub struct Domain {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "auditLogsEnabled")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Optional. Configuration for audit logs. True if audit logs are enabled, else false. Default is audit logs disabled."]
        pub audit_logs_enabled: ::std::option::Option<::std::primitive::bool>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "authorizedNetworks")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Optional. The full names of the Google Compute Engine [networks](/compute/docs/networks-and-firewalls#networks) to which the instance is connected. Network can be added using UpdateDomain later. Domain is only available on network part of authorized_networks. Caller needs to make sure that CIDR subnets do not overlap between networks, else domain creation will fail."]
        pub authorized_networks: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "createTime")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The time the instance was created. Synthetic field is populated automatically by CCFE. go/ccfe-synthetic-field-user-guide"]
        pub create_time: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "fqdn")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. Fully-qualified domain name of the exposed domain used by clients to connect to the service. Similar to what would be chosen for an Active Directory that is set up on an internal network."]
        ...
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "managedIdentitiesAdminName")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Optional. Name of customer-visible admin used to perform Active Directory operations. If not specified `setupadmin` would be used."]
        pub managed_identities_admin_name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. Unique name of the domain in this scope including projects and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`."]
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. Last update time. Synthetic field is populated automatically by CCFE."]
    ...
    pub enum DomainStateEnum {
        ...
        #[doc = "ManagedIdentities domain is being created."]
        Creating,
        #[serde(rename = "READY")]
        #[doc = "ManagedIdentities domain has been created and is fully usable."]
        Ready,
        #[serde(rename = "UPDATING")]
        #[doc = "ManagedIdentities domain configuration is being updated."]
        Updating,
        #[serde(rename = "DELETING")]
        #[doc = "ManagedIdentities domain is being deleted."]
        Deleting,
        #[serde(rename = "REPAIRING")]
        #[doc = "ManagedIdentities domain is being repaired and may be unusable. Details can be found in the `status_message` field."]
        Repairing,
        #[serde(rename = "PERFORMING_MAINTENANCE")]
        #[doc = "ManagedIdentities domain is undergoing maintenance."]
        PerformingMaintenance,
        #[serde(rename = "DOWN")]
        #[doc = "ManagedIdentities domain is not serving customer requests."]
        Down,
    }
    ...
    #[doc = "ListSQLIntegrationsResponse is the response message for ListSQLIntegrations method."]
    pub struct ListSqlIntegrationsResponse {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "A list of SQLIntegrations of a domain."]
        pub sql_integrations:
            ::std::option::Option<::std::vec::Vec<::std::boxed::Box<SqlIntegration>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "unreachable")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    impl ListSqlIntegrationsResponse {
        pub fn builder() -> ListSqlIntegrationsResponseBuilder {
            ListSqlIntegrationsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct ReconfigureTrustRequest {
        ...
        #[serde(rename = "trust")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The domain trust resource with updated dns conditional forwarder."]
        pub trust: ::std::option::Option<::std::boxed::Box<Trust>>,
    }
    ...
    #[doc = "Represents the SQL instance integrated with AD."]
    pub struct SqlIntegration {
        ...
        #[serde(rename = "name")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The unique name of the sql integration in the form of `projects/{project_id}/locations/global/domains/{domain_name}/sqlIntegrations/{sql_integration}`"]
        pub name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "sqlInstance")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The full resource name of an integrated sql instance"]
        pub sql_instance: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "state")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The current state of the managed OU."]
        pub state: ::std::option::Option<SqlIntegrationStateEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "updateTime")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. Last update time. Synthetic field is populated automatically by CCFE."]
    ...
    impl SqlIntegration {
        pub fn builder() -> SqlIntegrationBuilder {
            SqlIntegrationBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Output only. The current state of the managed OU."]
    pub enum SqlIntegrationStateEnum {
        ...
        StateUnspecified,
        #[serde(rename = "CREATING")]
        #[doc = "The sqlIntegration is being created."]
        Creating,
        #[serde(rename = "DELETING")]
        #[doc = "The sqlIntegration is being deleted."]
        Deleting,
        #[serde(rename = "READY")]
        #[doc = "The sqlIntegration is ready."]
        Ready,
    }
    impl ::std::default::Default for SqlIntegrationStateEnum {
        fn default() -> Self {
            Self::StateUnspecified
        }
    }
    ...
    pub struct Trust {
        ...
        pub create_time: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "lastKnownTrustConnectedHeartbeatTime")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The last heartbeat time when the trust was known to be connected."]
        pub last_known_trust_connected_heartbeat_time: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "selectiveAuthentication")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The trust authentication type which decides whether the trusted side has forest/domain wide access or selective access to approved set of resources."]
        pub selective_authentication: ::std::option::Option<::std::primitive::bool>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "state")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The current state of this trust."]
        pub state: ::std::option::Option<TrustStateEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "stateDescription")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. Additional information about the current state of this trust, if available."]
        pub state_description: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "targetDnsIpAddresses")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The target dns server ip addresses which can resolve the remote domain involved in trust."]
        pub target_dns_ip_addresses: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "targetDomainName")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The fully qualified target domain name which will be in trust with current domain."]
        pub target_domain_name: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "trustDirection")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The trust direction decides the current domain is trusted, trusting or both."]
        pub trust_direction: ::std::option::Option<TrustTrustDirectionEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "trustHandshakeSecret")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Input only, and will not be stored. The trust secret used for handshake with target domain."]
        pub trust_handshake_secret: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "trustType")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The type of trust represented by the trust resource."]
        pub trust_type: ::std::option::Option<TrustTrustTypeEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "updateTime")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. Last update time."]
        pub update_time: ::std::option::Option<::std::string::String>,
    }
    impl Trust {
    ...
    pub enum TrustStateEnum {
        ...
        StateUnspecified,
        #[serde(rename = "CREATING")]
        #[doc = "Domain trust is being created."]
        Creating,
        #[serde(rename = "UPDATING")]
        #[doc = "Domain trust is being updated."]
        Updating,
        #[serde(rename = "DELETING")]
        #[doc = "Domain trust is being deleted."]
        Deleting,
        #[serde(rename = "CONNECTED")]
        #[doc = "Domain trust is connected."]
        Connected,
        #[serde(rename = "DISCONNECTED")]
        #[doc = "Domain trust is disconnected."]
        Disconnected,
    }
    ...
    pub struct ValidateTrustRequest {
        ...
        #[serde(rename = "trust")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The domain trust to validate trust state for."]
        pub trust: ::std::option::Option<::std::boxed::Box<Trust>>,
    }
