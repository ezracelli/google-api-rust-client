...
pub struct ApplicationReport {
    ...
    pub keyed_app_states: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<KeyedAppState>>>,
    #[serde(rename = "packageName")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct Command {
    ...
    pub reset_password_flags: ::std::option::Option<::std::vec::Vec<CommandResetPasswordFlagsEnum>>,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct Device {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Information about Common Criteria Mode—security standards defined in the Common Criteria for Information Technology Security Evaluation (https://www.commoncriteriaportal.org/) (CC).This information is only available if statusReportingSettings.commonCriteriaModeEnabled is true in the device's policy."]
    pub common_criteria_mode_info: ::std::option::Option<::std::boxed::Box<CommonCriteriaModeInfo>>,
...
pub struct HardwareInfo {
    ...
    pub cpu_shutdown_temperatures: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
    #[serde(rename = "cpuThrottlingTemperatures")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "CPU throttling temperature thresholds in Celsius for each CPU on the device."]
    pub cpu_throttling_temperatures: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
    ...
    pub gpu_shutdown_temperatures: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
    #[serde(rename = "gpuThrottlingTemperatures")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "GPU throttling temperature thresholds in Celsius for each GPU on the device."]
    pub gpu_throttling_temperatures: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
    ...
    pub skin_shutdown_temperatures: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
    #[serde(rename = "skinThrottlingTemperatures")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Device skin throttling temperature thresholds in Celsius."]
    pub skin_throttling_temperatures: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct ManagedProperty {
    ...
    pub entries: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ManagedPropertyEntry>>>,
    #[serde(rename = "key")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct NetworkInfo {
    ...
    pub telephony_infos: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<TelephonyInfo>>>,
...
pub struct NonComplianceDetail {
    ...
    pub non_compliance_reason: ::std::option::Option<NonComplianceDetailNonComplianceReasonEnum>,
    #[serde(rename = "packageName")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct Policy {
    ...
    pub applications: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ApplicationPolicy>>>,
    ...
    pub compliance_rules: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ComplianceRule>>>,
    ...
    pub device_owner_lock_screen_info: ::std::option::Option<::std::boxed::Box<UserFacingMessage>>,
    ...
    pub permitted_accessibility_services: ::std::option::Option<::std::boxed::Box<PackageNameList>>,
    ...
    pub personal_usage_policies: ::std::option::Option<::std::boxed::Box<PersonalUsagePolicies>>,
    ...
    pub stay_on_plugged_modes: ::std::option::Option<::std::vec::Vec<PolicyStayOnPluggedModesEnum>>,
...
pub struct SecurityPosture {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Additional details regarding the security posture of the device."]
    pub posture_details: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<PostureDetail>>>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Device's security posture value."]
