...
pub struct Environment {
    ...
    pub version: ::std::option::Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
...
pub struct ExecutionStageState {
    ...
    pub execution_stage_state: ::std::option::Option<ExecutionStageStateExecutionStageStateEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "Executions stage states allow the same set of values as JobState."]
...
pub struct FlexTemplateRuntimeEnvironment {
    ...
    pub ip_configuration: ::std::option::Option<FlexTemplateRuntimeEnvironmentIpConfigurationEnum>,
...
pub struct JobMetadata {
    ...
    pub pubsub_details: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<PubSubIoDetails>>>,
...
pub struct ListJobsResponse {
    ...
    pub failed_location: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<FailedLocation>>>,
    #[serde(rename = "jobs")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct MetricStructuredName {
    ...
    pub context: ::std::option::Option<::std::collections::BTreeMap<String, ::std::string::String>>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct ParDoInstruction {
    ...
    pub user_fn: ::std::option::Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct RuntimeMetadata {
    ...
    pub parameters: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ParameterMetadata>>>,
    #[serde(rename = "sdkInfo")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct SendWorkerMessagesRequest {
    ...
    pub worker_messages: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<WorkerMessage>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct StreamLocation {
    ...
    pub side_input_location: ::std::option::Option<::std::boxed::Box<StreamingSideInputLocation>>,
    ...
    pub streaming_stage_location: ::std::option::Option<::std::boxed::Box<StreamingStageLocation>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct StreamingSetupTask {
    ...
    pub snapshot_config: ::std::option::Option<::std::boxed::Box<StreamingApplianceSnapshotConfig>>,
    #[serde(rename = "streamingComputationTopology")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "The global topology of the streaming Dataflow job."]
    pub streaming_computation_topology: ::std::option::Option<::std::boxed::Box<TopologyConfig>>,
...
pub struct WorkItemServiceState {
    ...
    pub metric_short_id: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<MetricShortId>>>,
...
pub struct WorkItemStatus {
    ...
    pub counter_updates: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CounterUpdate>>>,
    ...
    pub reported_progress: ::std::option::Option<::std::boxed::Box<ApproximateReportedProgress>>,
    #[serde(rename = "requestedLeaseDuration")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct WorkerPool {
    ...
    pub pool_args: ::std::option::Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
