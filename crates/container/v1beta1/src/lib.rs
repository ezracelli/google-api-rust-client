...
pub mod schemas {
    ...
    impl AvailableVersion {
        pub fn builder() -> AvailableVersionBuilder {
            AvailableVersionBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ::std::default::Default for ClusterAutoscalingAutoscalingProfileEnum {
        fn default() -> Self {
    ...
    impl ClusterTelemetry {
        pub fn builder() -> ClusterTelemetryBuilder {
            ClusterTelemetryBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Type of the integration."]
    ...
    impl ::std::default::Default for ClusterTelemetryTypeEnum {
        fn default() -> Self {
            Self::Unspecified
        }
    }
    ...
    pub struct ClusterUpdate {
        ...
        pub desired_datapath_provider:
            ::std::option::Option<ClusterUpdateDesiredDatapathProviderEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl ::std::default::Default for ClusterUpdateDesiredDatapathProviderEnum {
        fn default() -> Self {
            Self::DatapathProviderUnspecified
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "The desired state of IPv6 connectivity to Google Services."]
    ...
    impl ConfidentialNodes {
        pub fn builder() -> ConfidentialNodesBuilder {
            ConfidentialNodesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl EphemeralStorageConfig {
        pub fn builder() -> EphemeralStorageConfigBuilder {
            EphemeralStorageConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ::std::default::Default for IstioConfigAuthEnum {
        fn default() -> Self {
            Self::AuthNone
        }
    }
    ...
    impl KalmConfig {
        pub fn builder() -> KalmConfigBuilder {
            KalmConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ::std::default::Default for NetworkConfigDatapathProviderEnum {
        fn default() -> Self {
            Self::DatapathProviderUnspecified
        }
    }
    ...
    pub struct NodeConfig {
        ...
        pub ephemeral_storage_config:
            ::std::option::Option<::std::boxed::Box<EphemeralStorageConfig>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl PodSecurityPolicyConfig {
        pub fn builder() -> PodSecurityPolicyConfigBuilder {
            PodSecurityPolicyConfigBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ::std::default::Default for StatusConditionCanonicalCodeEnum {
        fn default() -> Self {
            Self::Ok
        }
    }
    ...
    impl UpgradeAvailableEvent {
        pub fn builder() -> UpgradeAvailableEventBuilder {
            UpgradeAvailableEventBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "The resource type of the release version."]
    ...
    impl ::std::default::Default for UpgradeAvailableEventResourceTypeEnum {
        fn default() -> Self {
    ...
    impl ::std::default::Default for WorkloadMetadataConfigNodeMetadataEnum {
        fn default() -> Self {
            Self::Unspecified
        }
    }
