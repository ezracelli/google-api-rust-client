                        ...
                        pub mod methods {
                            ...
                            pub mod list {
                                ...
                                pub struct QueryParameters {
                                    ...
                                    #[doc = "The maximum number of repositories to return. Maximum page size is 10,000."]
                                    pub page_size: ::std::option::Option<::std::primitive::i64>,
                                    #[builder(
                                        default = "{ ::std::default::Default::default() }",
                                        setter(into)
                                ...
                                pub mod methods {
                                    pub mod list {
                                        ...
                                        pub struct QueryParameters {
                                            ...
                                            #[doc = "The maximum number of packages to return. Maximum page size is 10,000."]
                                            pub page_size:
                                                ::std::option::Option<::std::primitive::i64>,
                                            #[builder(
                                                default = "{ ::std::default::Default::default() }",
                                        ...
                                        pub mod methods {
                                            ...
                                            pub mod list {
                                                ...
                                                pub struct QueryParameters {
                                                    ...
                                                    #[doc = "The maximum number of tags to return. Maximum page size is 10,000."]
                                        ...
                                        pub mod methods {
                                            ...
                                            pub mod list {
                                                ...
                                                pub struct QueryParameters {
                                                    ...
                                                    #[doc = "The maximum number of versions to return. Maximum page size is 10,000."]
                                                    pub page_size: ::std::option::Option<
                                                        ::std::primitive::i64,
                                                    >,
                                                    #[builder(
...
pub mod schemas {
    ...
    pub struct Repository {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The Cloud KMS resource name of the customer managed encryption key that’s used to encrypt the contents of the Repository. Has the form: `projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key`. This value may not be changed after the Repository has been created."]
