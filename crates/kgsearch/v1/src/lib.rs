        ...
        pub mod methods {
            pub mod search {
                ...
                pub struct QueryParameters {
                    ...
                    #[serde(rename = "indent")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "Enables indenting of json results."]
                    pub indent: ::std::option::Option<::std::primitive::bool>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    ...
                    #[serde(rename = "limit")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "Limits the number of entities to be returned."]
                    pub limit: ::std::option::Option<::std::primitive::i64>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "prefix")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "Enables prefix match against names and aliases of entities"]
                    pub prefix: ::std::option::Option<::std::primitive::bool>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "query")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "The literal query string for search."]
