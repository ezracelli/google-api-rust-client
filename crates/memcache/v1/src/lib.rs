...
pub mod schemas {
    ...
    impl GoogleCloudMemcacheV1OperationMetadata {
        pub fn builder() -> GoogleCloudMemcacheV1OperationMetadataBuilder {
            GoogleCloudMemcacheV1OperationMetadataBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct Instance {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The full name of the Google Compute Engine [network](/compute/docs/networks-and-firewalls#networks) to which the instance is connected. If left unspecified, the `default` network will be used."]
