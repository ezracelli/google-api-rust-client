        ...
        pub mod methods {
            pub mod list {
                ...
                pub struct QueryParameters {
                    ...
                    pub sort: ::std::option::Option<QueryParametersSortEnum>,
                }
                impl QueryParameters {
                    pub fn builder() -> QueryParametersBuilder {
                        QueryParametersBuilder::default()
                ...
                #[doc = "Enables sorting of the list."]
                pub enum QueryParametersSortEnum {
                    #[serde(rename = "SORT_UNDEFINED")]
                    #[doc = "No sorting specified, use the default sorting method."]
                    SortUndefined,
                    #[serde(rename = "ALPHA")]
                ...
                impl ::std::default::Default for QueryParametersSortEnum {
                    fn default() -> Self {
                        Self::SortUndefined
                    }
                }
...
pub mod schemas {
    ...
    impl Webfont {
        pub fn builder() -> WebfontBuilder {
            WebfontBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl WebfontList {
        pub fn builder() -> WebfontListBuilder {
            WebfontListBuilder::default()
        }
    }
}
