...
pub struct AndroidConfig {
    ...
    pub data: ::std::option::Option<::std::collections::BTreeMap<String, ::std::string::String>>,
...
pub struct AndroidNotification {
    ...
    pub notification_priority: ::std::option::Option<AndroidNotificationNotificationPriorityEnum>,
    #[serde(rename = "sound")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
