                ...
                pub mod methods {
                    pub mod list {
                        ...
                        pub struct QueryParameters {
                            ...
                            #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                            #[doc = "The maximum number of bidding functions to return."]
                            ...
                            #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                            #[doc = "A token identifying a page of results the server should return. This value is received from a previous `ListBiddingFunctions` call in ListBiddingFunctionsResponse.nextPageToken."]
...
pub mod schemas {
    ...
    impl BiddingFunction {
        pub fn builder() -> BiddingFunctionBuilder {
            BiddingFunctionBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl ListBiddingFunctionsResponse {
        pub fn builder() -> ListBiddingFunctionsResponseBuilder {
            ListBiddingFunctionsResponseBuilder::default()
        }
    }
}
