...
pub mod schemas {
    ...
    impl ListTraceSinksResponse {
        pub fn builder() -> ListTraceSinksResponseBuilder {
            ListTraceSinksResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl TraceSink {
        pub fn builder() -> TraceSinkBuilder {
            TraceSinkBuilder::default()
        }
    }
}
