...
pub struct GoogleCloudPolicysimulatorV1beta1AccessStateDiff {
    ...
    pub baseline:
        ::std::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1beta1ExplainedAccess>>,
...
pub struct GoogleCloudPolicysimulatorV1beta1ExplainedPolicy {
    ...
    pub access: ::std::option::Option<GoogleCloudPolicysimulatorV1beta1ExplainedPolicyAccessEnum>,
...
pub struct GoogleCloudPolicysimulatorV1beta1ReplayDiff {
    ...
    pub access_diff:
        ::std::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1beta1AccessStateDiff>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct GoogleCloudPolicysimulatorV1beta1ReplayResult {
    ...
    pub diff: ::std::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1beta1ReplayDiff>>,
    #[serde(rename = "error")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
