...
pub struct GoogleCloudRetailV2alphaListCatalogsResponse {
    ...
    pub catalogs:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudRetailV2alphaCatalog>>>,
...
pub struct GoogleCloudRetailV2alphaPredictResponse {
    ...
    pub results: ::std::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudRetailV2alphaPredictResponsePredictionResult>>,
    >,
    #[serde(rename = "validateOnly")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudRetailV2alphaProduct {
    ...
    pub images:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudRetailV2alphaImage>>>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudRetailV2alphaProductInlineSource {
    ...
    pub products:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudRetailV2alphaProduct>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
