...
pub struct GoogleCloudRetailV2Product {
    ...
    pub attributes: ::std::option::Option<
        ::std::collections::BTreeMap<String, ::std::boxed::Box<GoogleCloudRetailV2CustomAttribute>>,
    >,
    ...
    pub images: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudRetailV2Image>>>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudRetailV2RejoinUserEventsRequest {
    ...
    pub user_event_rejoin_scope:
        ::std::option::Option<GoogleCloudRetailV2RejoinUserEventsRequestUserEventRejoinScopeEnum>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "The type of the user event rejoin to define the scope and range of the user events to be rejoined with the latest product catalog. Defaults to USER_EVENT_REJOIN_SCOPE_UNSPECIFIED if this field is not set, or set to an invalid integer value."]
...
pub struct GoogleCloudRetailV2UserEvent {
    ...
    pub product_details:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudRetailV2ProductDetail>>>,
