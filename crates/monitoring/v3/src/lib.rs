...
pub struct CollectdPayload {
    ...
    pub metadata:
        ::std::option::Option<::std::collections::BTreeMap<String, ::std::boxed::Box<TypedValue>>>,
    #[serde(rename = "plugin")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct CollectdPayloadError {
    ...
    pub value_errors: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CollectdValueError>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct ListNotificationChannelDescriptorsResponse {
    ...
    pub channel_descriptors:
        ::std::option::Option<::std::vec::Vec<::std::boxed::Box<NotificationChannelDescriptor>>>,
    #[serde(rename = "nextPageToken")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct ListUptimeCheckIpsResponse {
    ...
    pub uptime_check_ips: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<UptimeCheckIp>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct NotificationChannel {
    ...
    pub mutation_records: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<MutationRecord>>>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct QueryTimeSeriesResponse {
    ...
    pub time_series_data: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<TimeSeriesData>>>,
...
pub struct Service {
    ...
    pub istio_canonical_service: ::std::option::Option<::std::boxed::Box<IstioCanonicalService>>,
...
pub struct ServiceLevelObjective {
    ...
    pub service_level_indicator: ::std::option::Option<::std::boxed::Box<ServiceLevelIndicator>>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
#[doc = "A calendar period, semantically \"since the start of the current \". At this time, only DAY, WEEK, FORTNIGHT, and MONTH are supported."]
...
pub struct UptimeCheckConfig {
    ...
    pub content_matchers: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ContentMatcher>>>,
    #[serde(rename = "displayName")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct WindowsBasedSli {
    ...
    pub good_total_ratio_threshold: ::std::option::Option<::std::boxed::Box<PerformanceThreshold>>,
