...
pub mod schemas {
    ...
    pub struct CollectionOverride {
        ...
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "methodMap")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Custom verb method mappings to support unordered list API mappings."]
        pub method_map: ::std::option::Option<::std::boxed::Box<MethodMap>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "options")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub struct Deployment {
        ...
        pub outputs:
            ::std::option::Option<::std::vec::Vec<::std::boxed::Box<DeploymentOutputEntry>>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "selfLink")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. Server defined URL for the resource."]
    ...
    #[doc = "Output object for Deployments"]
    ...
    impl DeploymentOutputEntry {
        pub fn builder() -> DeploymentOutputEntryBuilder {
            DeploymentOutputEntryBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    #[doc = "Deployment Manager will call these methods during the events of creation/deletion/update/get/setIamPolicy"]
    pub struct MethodMap {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "create")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The action identifier for the create method to be used for this collection"]
        pub create: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "delete")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub struct Options {
        ...
        pub name_property: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    pub struct Resource {
        ...
        pub insert_time: ::std::option::Option<::std::string::String>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "lastUsedCredential")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Output only. The last used credential that successfully created/updated the resource."]
        pub last_used_credential: ::std::option::Option<::std::boxed::Box<Credential>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "manifest")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        ...
        pub runtime_policies: ::std::option::Option<::std::vec::Vec<ResourceRuntimePoliciesEnum>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "type")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    pub enum ResourceRuntimePoliciesEnum {
        #[serde(rename = "CREATE")]
        #[doc = "The action will only be fired during create."]
        Create,
        #[serde(rename = "DELETE")]
        #[doc = "The action will only be fired when the action is removed from the deployment."]
        Delete,
        #[serde(rename = "UPDATE_ON_CHANGE")]
        #[doc = "The action will fire during create, and if there is any changes on the inputs."]
        UpdateOnChange,
        #[serde(rename = "UPDATE_ALWAYS")]
        #[doc = "The action will fire during create, and every time there is an update to the deployment."]
        UpdateAlways,
    }
    impl ::std::default::Default for ResourceRuntimePoliciesEnum {
        fn default() -> Self {
            Self::Create
        }
    }
    ...
    pub struct ResourceUpdate {
        ...
        pub runtime_policies:
            ::std::option::Option<::std::vec::Vec<ResourceUpdateRuntimePoliciesEnum>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "state")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    pub enum ResourceUpdateRuntimePoliciesEnum {
        #[serde(rename = "CREATE")]
        #[doc = "The action will only be fired during create."]
        Create,
        #[serde(rename = "DELETE")]
    ...
    impl ::std::default::Default for ResourceUpdateRuntimePoliciesEnum {
        fn default() -> Self {
            Self::Create
        }
    }
