...
pub struct ErrorSummary {
    ...
    pub error_log_entries: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ErrorLogEntry>>>,
}
...
pub struct TransferOperation {
    ...
    pub error_breakdowns: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ErrorSummary>>>,
    #[serde(rename = "name")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct TransferOptions {
    ...
    pub delete_objects_from_source_after_transfer: ::std::option::Option<::std::primitive::bool>,
    ...
    pub overwrite_objects_already_existing_in_sink: ::std::option::Option<::std::primitive::bool>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
