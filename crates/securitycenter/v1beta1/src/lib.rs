...
pub mod schemas {
    ...
    pub struct Asset {
        ...
        pub security_marks:
            ::std::option::Option<::std::boxed::Box<GoogleCloudSecuritycenterV1beta1SecurityMarks>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    pub struct GoogleCloudSecuritycenterV1beta1Finding {
        ...
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "The state of the finding."]
        pub state: ::std::option::Option<GoogleCloudSecuritycenterV1beta1FindingStateEnum>,
    }
    impl GoogleCloudSecuritycenterV1beta1Finding {
        pub fn builder() -> GoogleCloudSecuritycenterV1beta1FindingBuilder {
            GoogleCloudSecuritycenterV1beta1FindingBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "The state of the finding."]
    pub enum GoogleCloudSecuritycenterV1beta1FindingStateEnum {
        #[serde(rename = "STATE_UNSPECIFIED")]
        #[doc = "Unspecified state."]
        StateUnspecified,
        #[serde(rename = "ACTIVE")]
    ...
    impl ::std::default::Default for GoogleCloudSecuritycenterV1beta1FindingStateEnum {
        fn default() -> Self {
            Self::StateUnspecified
        }
    }
    ...
    impl GoogleCloudSecuritycenterV1beta1SecurityMarks {
        pub fn builder() -> GoogleCloudSecuritycenterV1beta1SecurityMarksBuilder {
            GoogleCloudSecuritycenterV1beta1SecurityMarksBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct ListAssetsResult {
        ...
        pub state: ::std::option::Option<ListAssetsResultStateEnum>,
    }
    ...
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "State of the asset."]
    pub enum ListAssetsResultStateEnum {
        #[serde(rename = "STATE_UNSPECIFIED")]
        #[doc = "Unspecified state."]
        StateUnspecified,
        #[serde(rename = "UNUSED")]
    ...
    impl ::std::default::Default for ListAssetsResultStateEnum {
        fn default() -> Self {
            Self::StateUnspecified
        }
    }
    ...
    pub struct ListFindingsResponse {
        ...
        pub findings: ::std::option::Option<
            ::std::vec::Vec<::std::boxed::Box<GoogleCloudSecuritycenterV1beta1Finding>>,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "nextPageToken")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    #[doc = "Security Command Center finding source. A finding source is an entity or a mechanism that can produce a finding. A source is like a container of findings that come from the same scanner, logger, monitor, etc."]
    pub struct Source {
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "description")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
