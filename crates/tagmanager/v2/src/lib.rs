...
pub struct ContainerVersion {
    ...
    pub custom_template: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CustomTemplate>>>,
...
pub struct GetWorkspaceStatusResponse {
    ...
    pub merge_conflict: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<MergeConflict>>>,
...
pub struct ListUserPermissionsResponse {
    ...
    pub user_permission: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<UserPermission>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct ZoneBoundary {
    ...
    pub custom_evaluation_trigger_id: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
