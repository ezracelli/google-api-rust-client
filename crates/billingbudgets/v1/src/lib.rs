...
pub mod schemas {
    ...
    pub struct GoogleCloudBillingBudgetsV1Budget {
        ...
        pub amount:
            ::std::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1BudgetAmount>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub budget_filter:
            ::std::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1Filter>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl GoogleCloudBillingBudgetsV1Budget {
        pub fn builder() -> GoogleCloudBillingBudgetsV1BudgetBuilder {
            GoogleCloudBillingBudgetsV1BudgetBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleCloudBillingBudgetsV1BudgetAmount {
        pub fn builder() -> GoogleCloudBillingBudgetsV1BudgetAmountBuilder {
            GoogleCloudBillingBudgetsV1BudgetAmountBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleCloudBillingBudgetsV1CustomPeriod {
        pub fn builder() -> GoogleCloudBillingBudgetsV1CustomPeriodBuilder {
            GoogleCloudBillingBudgetsV1CustomPeriodBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleCloudBillingBudgetsV1Filter {
        ...
        pub calendar_period:
            ::std::option::Option<GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl GoogleCloudBillingBudgetsV1Filter {
        pub fn builder() -> GoogleCloudBillingBudgetsV1FilterBuilder {
            GoogleCloudBillingBudgetsV1FilterBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Optional. Specifies to track usage for recurring calendar period. E.g. Assume that CalendarPeriod.QUARTER is set. The budget will track usage from April 1 to June 30, when current calendar month is April, May, June. After that, it will track usage from July 1 to September 30 when current calendar month is July, August, September, and so on."]
    ...
    impl ::std::default::Default for GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum {
        fn default() -> Self {
    ...
    impl ::std::default::Default for GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum {
        fn default() -> Self {
    ...
    impl GoogleCloudBillingBudgetsV1LastPeriodAmount {
        pub fn builder() -> GoogleCloudBillingBudgetsV1LastPeriodAmountBuilder {
            GoogleCloudBillingBudgetsV1LastPeriodAmountBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleCloudBillingBudgetsV1ListBudgetsResponse {
        pub fn builder() -> GoogleCloudBillingBudgetsV1ListBudgetsResponseBuilder {
            GoogleCloudBillingBudgetsV1ListBudgetsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl GoogleCloudBillingBudgetsV1NotificationsRule {
        pub fn builder() -> GoogleCloudBillingBudgetsV1NotificationsRuleBuilder {
            GoogleCloudBillingBudgetsV1NotificationsRuleBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct GoogleCloudBillingBudgetsV1ThresholdRule {
        ...
        pub spend_basis:
            ::std::option::Option<GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl GoogleCloudBillingBudgetsV1ThresholdRule {
        pub fn builder() -> GoogleCloudBillingBudgetsV1ThresholdRuleBuilder {
            GoogleCloudBillingBudgetsV1ThresholdRuleBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Optional. The type of basis used to determine if spend has passed the threshold. Behavior defaults to CURRENT_SPEND if not set."]
    ...
    impl ::std::default::Default for GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum {
        fn default() -> Self {
