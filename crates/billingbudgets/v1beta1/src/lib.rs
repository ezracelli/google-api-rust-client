...
pub struct GoogleCloudBillingBudgetsV1beta1Budget {
    ...
    pub all_updates_rule:
        ::std::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1beta1AllUpdatesRule>>,
    #[serde(rename = "amount")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct GoogleCloudBillingBudgetsV1beta1BudgetAmount {
    ...
    pub last_period_amount:
        ::std::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1beta1LastPeriodAmount>>,
...
pub struct GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest {
    ...
    pub budget: ::std::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1beta1Budget>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
