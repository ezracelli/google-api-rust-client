...
pub struct AllocateQuotaResponse {
    ...
    pub quota_metrics: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<MetricValueSet>>>,
    #[serde(rename = "serviceConfigId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct Auth {
    ...
    pub claims: ::std::option::Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
