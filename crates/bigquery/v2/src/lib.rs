...
pub struct ArimaCoefficients {
    ...
    pub auto_regressive_coefficients: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
    ...
    pub moving_average_coefficients: ::std::option::Option<::std::vec::Vec<::std::primitive::f64>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct ArimaForecastingMetrics {
    ...
    pub non_seasonal_order: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ArimaOrder>>>,
...
pub struct ArimaModelInfo {
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Seasonal periods. Repeated because multiple periods are supported for one time series."]
    pub seasonal_periods: ::std::option::Option<::std::vec::Vec<ArimaModelInfoSeasonalPeriodsEnum>>,
    #[serde(rename = "timeSeriesId")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct ArimaResult {
    ...
    pub arima_model_info: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ArimaModelInfo>>>,
    #[serde(rename = "seasonalPeriods")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Seasonal periods. Repeated because multiple periods are supported for one time series."]
    pub seasonal_periods: ::std::option::Option<::std::vec::Vec<ArimaResultSeasonalPeriodsEnum>>,
}
#[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
...
pub struct CategoricalValue {
    ...
    pub category_counts: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<CategoryCount>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
...
pub struct JobConfigurationQuery {
    ...
    pub query_parameters: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<QueryParameter>>>,
    #[serde(rename = "rangePartitioning")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "[TrustedTester] Range partitioning specification for this table. Only one of timePartitioning and rangePartitioning should be specified."]
    pub range_partitioning: ::std::option::Option<::std::boxed::Box<RangePartitioning>>,
...
pub struct JobConfigurationTableCopy {
    ...
    pub source_tables: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<TableReference>>>,
    #[serde(rename = "writeDisposition")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "[Optional] Specifies the action that occurs if the destination table already exists. The following values are supported: WRITE_TRUNCATE: If the table already exists, BigQuery overwrites the table data. WRITE_APPEND: If the table already exists, BigQuery appends the data to the table. WRITE_EMPTY: If the table already exists and contains data, a 'duplicate' error is returned in the job result. The default value is WRITE_EMPTY. Each action is atomic and only occurs if BigQuery is able to complete the job successfully. Creation, truncation and append actions occur as one atomic update upon job completion."]
    pub write_disposition: ::std::option::Option<::std::string::String>,
...
pub struct JobStatistics {
    ...
    pub reservation_usage: ::std::option::Option<::std::vec::Vec<JobStatisticsReservationUsage>>,
...
pub struct JobStatistics2 {
    ...
    pub query_plan: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ExplainQueryStage>>>,
    ...
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "[Output-only] Job resource usage breakdown by reservation."]
    pub reservation_usage: ::std::option::Option<::std::vec::Vec<JobStatistics2ReservationUsage>>,
    #[serde(rename = "schema")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub timeline: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<QueryTimelineSample>>>,
...
pub struct JobStatistics4 {
    ...
    pub destination_uri_file_counts: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
...
pub struct Model {
    ...
    pub encryption_configuration: ::std::option::Option<::std::boxed::Box<EncryptionConfiguration>>,
    #[serde(rename = "etag")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
    #[doc = "Output only. A hash of this resource."]
    pub etag: ::std::option::Option<::std::string::String>,
    ...
    pub label_columns: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<StandardSqlField>>>,
    #[serde(rename = "labels")]
    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct ModelDefinition {
    ...
    pub training_runs: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<BqmlTrainingRun>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
#[doc = "[Output-only, Beta] Model options used for the first training run. These options are immutable for subsequent training runs. Default values are used for any options not specified in the input query."]
...
pub struct ScriptStatistics {
    ...
    pub stack_frames: ::std::option::Option<::std::vec::Vec<::std::boxed::Box<ScriptStackFrame>>>,
}
#[derive(Debug, Default, PartialEq, Clone, serde :: Serialize, serde :: Deserialize)]
#[serde(deny_unknown_fields)]
