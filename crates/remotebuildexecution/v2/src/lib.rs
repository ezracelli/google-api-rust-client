    ...
    pub mod action_results {
        pub mod methods {
            pub mod get {
                ...
                pub struct QueryParameters {
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "inlineOutputFiles")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "A hint to the server to inline the contents of the listed output files. Each path needs to exactly match one path in `output_files` in the Command message."]
                    pub inline_output_files: ::std::option::Option<::std::string::String>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "inlineStderr")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "A hint to the server to request inlining stderr in the ActionResult message."]
                    pub inline_stderr: ::std::option::Option<::std::primitive::bool>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "inlineStdout")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "A hint to the server to request inlining stdout in the ActionResult message."]
                    pub inline_stdout: ::std::option::Option<::std::primitive::bool>,
                }
                impl QueryParameters {
                    pub fn builder() -> QueryParametersBuilder {
                        QueryParametersBuilder::default()
            ...
            pub mod update {
                ...
                pub struct QueryParameters {
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "resultsCachePolicy.priority")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    ...
                    pub results_cache_policy_priority: ::std::option::Option<::std::primitive::i64>,
                }
                impl QueryParameters {
                    pub fn builder() -> QueryParametersBuilder {
                        QueryParametersBuilder::default()
        ...
        pub mod methods {
            pub mod get_tree {
                ...
                pub struct QueryParameters {
                    ...
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "A maximum page size to request. If present, the server will request no more than this many items. Regardless of whether a page size is specified, the server may place its own limit on the number of items to be returned and require the client to retrieve more items using a subsequent request."]
                    pub page_size: ::std::option::Option<::std::primitive::i64>,
                    #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
                    #[serde(rename = "pageToken")]
                    #[serde(skip_serializing_if = "::std::option::Option::is_none")]
                    #[doc = "A page token, which must be a value received in a previous GetTreeResponse. If present, the server will use that token as an offset, returning only that page and the ones that succeed it."]
...
pub mod schemas {
    ...
    impl BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities {
        pub fn builder() -> BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilitiesBuilder {
            BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilitiesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2BatchReadBlobsRequest {
        pub fn builder() -> BuildBazelRemoteExecutionV2BatchReadBlobsRequestBuilder {
            BuildBazelRemoteExecutionV2BatchReadBlobsRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2BatchReadBlobsResponse {
        pub fn builder() -> BuildBazelRemoteExecutionV2BatchReadBlobsResponseBuilder {
            BuildBazelRemoteExecutionV2BatchReadBlobsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse {
        pub fn builder() -> BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponseBuilder {
            BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest {
        pub fn builder() -> BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestBuilder {
            BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest {
        pub fn builder() -> BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequestBuilder {
            BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse {
        pub fn builder() -> BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseBuilder {
            BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse {
        pub fn builder() -> BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponseBuilder {
            BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct BuildBazelRemoteExecutionV2CacheCapabilities {
        ...
        pub cache_priority_capabilities: ::std::option::Option<
            ::std::boxed::Box<BuildBazelRemoteExecutionV2PriorityCapabilities>,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl BuildBazelRemoteExecutionV2CacheCapabilities {
        pub fn builder() -> BuildBazelRemoteExecutionV2CacheCapabilitiesBuilder {
            BuildBazelRemoteExecutionV2CacheCapabilitiesBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    ...
    impl ::std::default::Default for BuildBazelRemoteExecutionV2CacheCapabilitiesDigestFunctionEnum {
        fn default() -> Self {
            Self::Unknown
        }
    }
    ...
    impl ::std::default::Default
        for BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategyEnum
    {
        fn default() -> Self {
            Self::Unknown
        }
    ...
    impl BuildBazelRemoteExecutionV2ExecuteRequest {
        pub fn builder() -> BuildBazelRemoteExecutionV2ExecuteRequestBuilder {
            BuildBazelRemoteExecutionV2ExecuteRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct BuildBazelRemoteExecutionV2ExecutionCapabilities {
        ...
        pub digest_function: ::std::option::Option<
            BuildBazelRemoteExecutionV2ExecutionCapabilitiesDigestFunctionEnum,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub execution_priority_capabilities: ::std::option::Option<
            ::std::boxed::Box<BuildBazelRemoteExecutionV2PriorityCapabilities>,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        ...
        pub supported_node_properties:
            ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    }
    impl BuildBazelRemoteExecutionV2ExecutionCapabilities {
        pub fn builder() -> BuildBazelRemoteExecutionV2ExecutionCapabilitiesBuilder {
            BuildBazelRemoteExecutionV2ExecutionCapabilitiesBuilder::default()
        }
    }
    #[derive(Debug, PartialEq, Copy, Clone, serde :: Serialize, serde :: Deserialize)]
    #[doc = "Remote execution may only support a single digest function."]
    ...
    impl ::std::default::Default
        for BuildBazelRemoteExecutionV2ExecutionCapabilitiesDigestFunctionEnum
    {
        fn default() -> Self {
            Self::Unknown
        }
    ...
    impl BuildBazelRemoteExecutionV2ExecutionPolicy {
        pub fn builder() -> BuildBazelRemoteExecutionV2ExecutionPolicyBuilder {
            BuildBazelRemoteExecutionV2ExecutionPolicyBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2FindMissingBlobsRequest {
        pub fn builder() -> BuildBazelRemoteExecutionV2FindMissingBlobsRequestBuilder {
            BuildBazelRemoteExecutionV2FindMissingBlobsRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2FindMissingBlobsResponse {
        pub fn builder() -> BuildBazelRemoteExecutionV2FindMissingBlobsResponseBuilder {
            BuildBazelRemoteExecutionV2FindMissingBlobsResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2GetTreeResponse {
        pub fn builder() -> BuildBazelRemoteExecutionV2GetTreeResponseBuilder {
            BuildBazelRemoteExecutionV2GetTreeResponseBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2PriorityCapabilities {
        pub fn builder() -> BuildBazelRemoteExecutionV2PriorityCapabilitiesBuilder {
            BuildBazelRemoteExecutionV2PriorityCapabilitiesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange {
        pub fn builder() -> BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRangeBuilder {
            BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRangeBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2ResultsCachePolicy {
        pub fn builder() -> BuildBazelRemoteExecutionV2ResultsCachePolicyBuilder {
            BuildBazelRemoteExecutionV2ResultsCachePolicyBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    pub struct BuildBazelRemoteExecutionV2ServerCapabilities {
        ...
        pub deprecated_api_version:
            ::std::option::Option<::std::boxed::Box<BuildBazelSemverSemVer>>,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
        #[serde(rename = "executionCapabilities")]
        #[serde(skip_serializing_if = "::std::option::Option::is_none")]
        #[doc = "Capabilities of the remote execution system."]
        pub execution_capabilities: ::std::option::Option<
            ::std::boxed::Box<BuildBazelRemoteExecutionV2ExecutionCapabilities>,
        >,
        #[builder(default = "{ ::std::default::Default::default() }", setter(into))]
    ...
    impl BuildBazelRemoteExecutionV2ServerCapabilities {
        pub fn builder() -> BuildBazelRemoteExecutionV2ServerCapabilitiesBuilder {
            BuildBazelRemoteExecutionV2ServerCapabilitiesBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelRemoteExecutionV2WaitExecutionRequest {
        pub fn builder() -> BuildBazelRemoteExecutionV2WaitExecutionRequestBuilder {
            BuildBazelRemoteExecutionV2WaitExecutionRequestBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
    ...
    impl BuildBazelSemverSemVer {
        pub fn builder() -> BuildBazelSemverSemVerBuilder {
            BuildBazelSemverSemVerBuilder::default()
        }
    }
    #[derive(
        Clone, Debug, PartialEq, derive_builder :: Builder, serde :: Serialize, serde :: Deserialize,
